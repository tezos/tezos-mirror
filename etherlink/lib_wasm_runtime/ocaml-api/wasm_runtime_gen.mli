...
external wasm_runtime_run: context -> string -> string option -> bool -> string -> Wasm_runtime_callbacks.scope -> Irmin_context.tree -> bytes -> int32 -> string list -> Irmin_context.tree = "wasm_runtime_run_bytecode" "wasm_runtime_run"
