...
pub const ALIAS_FORWARDER_SOL_CONTRACT: PredeployedContract = PredeployedContract {
    ...
    code_hash: FixedBytes::new([
        0x02, 0x64, 0x02, 0x4e, 0x6e, 0xd9, 0xfb, 0xc2, 0xb1, 0x14, 0x1e, 0xa3, 0x11,
        0x7e, 0x32, 0x32, 0xec, 0x37, 0xbe, 0x86, 0xae, 0x64, 0x68, 0x9e, 0x6a, 0x4b,
        0x4c, 0x6d, 0x8c, 0x19, 0x71, 0xd5,
    ]),
};
