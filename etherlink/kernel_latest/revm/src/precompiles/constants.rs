...
pub const ALIAS_FORWARDER_SOL_CONTRACT: PredeployedContract = PredeployedContract {
    ...
    code_hash: FixedBytes::new([
        0x1e, 0x8a, 0x45, 0x3c, 0xcf, 0x50, 0xf8, 0x4d, 0xd4, 0xf3, 0xae, 0x81, 0xc4,
        0xfd, 0xb3, 0x1e, 0x28, 0x66, 0x28, 0xd9, 0xfc, 0x47, 0x74, 0x29, 0x3d, 0x27,
        0x2d, 0x9c, 0xc7, 0x33, 0x9f, 0xe0,
    ]),
};
