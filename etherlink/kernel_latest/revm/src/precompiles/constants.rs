...
pub const ALIAS_FORWARDER_SOL_CONTRACT: PredeployedContract = PredeployedContract {
    ...
    code_hash: FixedBytes::new([
        0x58, 0x06, 0xbb, 0x9d, 0x60, 0xda, 0x7b, 0x6b, 0x74, 0x0f, 0xd8, 0x02, 0xed,
        0x2d, 0x33, 0x2f, 0x68, 0x3a, 0xf8, 0x59, 0xec, 0x9f, 0x53, 0xea, 0x1a, 0x9f,
        0x6b, 0x14, 0x4e, 0x44, 0xfa, 0x84,
    ]),
};
