...
use crate::{
    account_storage::{Manager, TezosAccount, TezosImplicitAccount},
    context,
...
fn get_revealed_key<Host: StorageV1>(
    host: &Host,
    account: &TezosImplicitAccount,
...
pub struct ValidatedBatch {
    pub source_account: TezosImplicitAccount,
