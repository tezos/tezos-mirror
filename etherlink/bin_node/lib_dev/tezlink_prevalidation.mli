...
(** [parse_and_validate_for_queue read ~data_model raw_op]
    ...
    The optionnal [check_signature] is used to bypass signature
    verifications during simulation. Similarly, [check_minimal_fees]
    (default [true]) can be set to [false] to skip the minimal fee
    check during simulation, allowing the client to simulate gas
    consumption before estimating fees.
