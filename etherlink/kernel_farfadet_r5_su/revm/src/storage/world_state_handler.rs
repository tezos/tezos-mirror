...
mod test {
    use crate::{
        ...
        precompiles::constants::{
            FA_BRIDGE_SOL_CONTRACT, INTERNAL_FORWARDER_SOL_CODE_HASH,
            INTERNAL_FORWARDER_SOL_CONTRACT, WITHDRAWAL_SOL_CODE_HASH,
    ...
    fn check_fa_withdrawal_code_info_fetching() {
        let mut host = MockKernelHost::default();
        let code_voucher =
            Bytecode::new_legacy(Bytes::from_static(FA_BRIDGE_SOL_CONTRACT.code));
