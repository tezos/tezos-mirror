...
function print_analysis(infos, dir = "analysis_result") {
    ...
    fs.writeFileSync(path.format({ dir, name: "object_" + OUTPUT }), csv.stringify(infos.tx_register, {
        header: true,
    ...
    fs.writeFileSync(path.format({ dir, name: "receipt_" + OUTPUT }), csv.stringify(infos.tx_register, {
        header: true,
    ...
    fs.writeFileSync(path.format({ dir, name: "bloom_" + OUTPUT }), csv.stringify(infos.tx_register, {
        header: true,
        columns: ["benchmark_name", "bloom_size", "logs_to_bloom"]
    }))
