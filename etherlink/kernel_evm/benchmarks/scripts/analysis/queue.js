...
function print_analysis(infos, dir = "analysis_result") {
    ...
    utils.print_csv(dir, OUTPUT_READ, read_data, ["benchmark_name", "queue_read", "queue_read_ticks"])
    ...
    utils.print_csv(dir, OUTPUT_STORE, store_data, ["benchmark_name", "queue_store", "queue_store_ticks"])
