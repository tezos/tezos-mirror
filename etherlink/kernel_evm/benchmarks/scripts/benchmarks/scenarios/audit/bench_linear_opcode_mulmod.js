...
let txs = [];
let contract = compile_contract_file(contracts_directory, "audit/opcode_mulmod.sol")[0];
...
txs.push(utils.send(player1, create.addr, 0, run(mode.extra.count, 1_000_000_000, 2_111, 999)))
