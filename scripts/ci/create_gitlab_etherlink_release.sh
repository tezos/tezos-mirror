...
gitlab_debian_packages_url=$(package_web_path "${gitlab_package_version}" "${gitlab_etherlink_debian_package_name}")
gitlab_ubuntu_packages_url=$(package_web_path "${gitlab_package_version}" "${gitlab_etherlink_ubuntu_package_name}")
