...
gitlab_debian_packages_url=$(package_web_path "${gitlab_octez_debian_package_name}")
gitlab_ubuntu_packages_url=$(package_web_path "${gitlab_octez_ubuntu_package_name}")
