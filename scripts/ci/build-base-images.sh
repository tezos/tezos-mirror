...
gcp="${GCP_CI_REGISTRY}/$CI_PROJECT_NAMESPACE/tezos/$DISTRIBUTION:$RELEASE-${LATEST_TAG}"
gcp_generic="${GCP_CI_REGISTRY}/$CI_PROJECT_NAMESPACE/tezos/$DISTRIBUTION:$RELEASE-${LATEST_TAG_GENERIC}"
protected_gcp="${GCP_PROTECTED_CI_REGISTRY}/tezos/tezos/$DISTRIBUTION:$RELEASE-$VERSION"
