...
# TODO: https://gitlab.com/tezos/tezos/-/issues/5924
# auto mode disabled: migration tezt was broken and hence removed by !9035.
if [ "$mode" = "auto" ]
then
    echo "
The 'auto' option has been disabled. See the issue:
