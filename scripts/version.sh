...
export full_opam_repository_tag=dd7b912ec4a9cd8efc790f611f4c3aefb35b5cb3
...
export opam_repository_tag="${OPAM_REPOSITORY_TAG:-e865763ca8a9cd8921877de094c60a94c1549f32}"
