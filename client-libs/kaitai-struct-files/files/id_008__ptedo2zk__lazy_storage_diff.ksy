...
types:
  ...
  big_map:
    seq:
    - id: id
      type: id_008__ptedo2zk__big_map_id
  ...
  copy_0:
    seq:
    - id: source
      type: id_008__ptedo2zk__sapling_state_id
  ...
  diff_0:
    ...
    - id: alloc
      type: alloc_0
      if: (diff_tag == diff_tag::alloc)
  id_008__ptedo2zk__big_map_id:
    seq:
    - id: id_008__ptedo2zk__big_map_id
      type: z
  id_008__ptedo2zk__lazy_storage_diff:
    seq:
  ...
  id_008__ptedo2zk__sapling_state_id:
    seq:
    - id: id_008__ptedo2zk__sapling_state_id
      type: z
...
- id: len_id_008__ptedo2zk__lazy_storage_diff
  ...
  valid:
    max: 1073741823
- id: id_008__ptedo2zk__lazy_storage_diff
  type: id_008__ptedo2zk__lazy_storage_diff
