meta:
  id: id_024__pttallin__operation__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 024-PtTALLiN.operation.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_024__pttallin__operation__alpha__unsigned_operation:
    seq:
    - id: id_024__pttallin__operation__alpha__unsigned_operation
      type: operation__shell_header
    - id: contents
...
seq:
- id: id_024__pttallin__operation__alpha__unsigned_operation
  type: id_024__pttallin__operation__alpha__unsigned_operation
