meta:
  id: id_010__ptgranad__operation__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 010-PtGRANAD.operation.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_010__ptgranad__operation__alpha__unsigned_operation:
    seq:
    - id: id_010__ptgranad__operation__alpha__unsigned_operation
      type: operation__shell_header
    - id: contents
...
seq:
- id: id_010__ptgranad__operation__alpha__unsigned_operation
  type: id_010__ptgranad__operation__alpha__unsigned_operation
