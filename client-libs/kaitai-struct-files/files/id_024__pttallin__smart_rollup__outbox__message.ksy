meta:
  id: id_024__pttallin__smart_rollup__outbox__message
  endian: be
doc: ! 'Encoding id: 024-PtTALLiN.smart_rollup.outbox.message'
types:
  args:
    seq:
    - id: args_entries
...
enums:
  ...
  id_024__pttallin__smart_rollup__outbox__message_tag:
  ...
  public_key_hash_tag:
    ...
    3: bls
seq:
- id: id_024__pttallin__smart_rollup__outbox__message_tag
  type: u1
  enum: id_024__pttallin__smart_rollup__outbox__message_tag
- id: atomic_transaction_batch
  type: transactions_0
  if: (id_024__pttallin__smart_rollup__outbox__message_tag == id_024__pttallin__smart_rollup__outbox__message_tag::atomic_transaction_batch)
- id: atomic_transaction_batch_typed
  type: transactions_2
  if: (id_024__pttallin__smart_rollup__outbox__message_tag == id_024__pttallin__smart_rollup__outbox__message_tag::atomic_transaction_batch_typed)
- id: whitelist_update
  type: whitelist_update
  if: (id_024__pttallin__smart_rollup__outbox__message_tag == id_024__pttallin__smart_rollup__outbox__message_tag::whitelist_update)
