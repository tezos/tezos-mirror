meta:
  id: id_018__proxford__operation_with_attestation
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 018-Proxford.operation_with_attestation'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_018__proxford__mutez:
    ...
    - id: id_018__proxford__mutez
      type: n
  id_018__proxford__operation__alpha__contents_and_signature:
    seq:
...
- id: id_018__proxford__operation_with_attestation
  type: operation__shell_header
- id: id_018__proxford__operation__alpha__contents_and_signature
  type: id_018__proxford__operation__alpha__contents_and_signature
