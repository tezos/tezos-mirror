meta:
  id: id_011__pthangz2__operation__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 011-PtHangz2.operation.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_011__pthangz2__operation__alpha__unsigned_operation:
    seq:
    - id: id_011__pthangz2__operation__alpha__unsigned_operation
      type: operation__shell_header
    - id: contents
...
seq:
- id: id_011__pthangz2__operation__alpha__unsigned_operation
  type: id_011__pthangz2__operation__alpha__unsigned_operation
