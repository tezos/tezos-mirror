...
- id: id_021__psquebec__smart_rollup__outbox__message_tag
  type: u1
  enum: id_021__psquebec__smart_rollup__outbox__message_tag
- id: atomic_transaction_batch
  type: transactions_0
  if: (id_021__psquebec__smart_rollup__outbox__message_tag == id_021__psquebec__smart_rollup__outbox__message_tag::atomic_transaction_batch)
- id: atomic_transaction_batch_typed
  type: transactions_2
  if: (id_021__psquebec__smart_rollup__outbox__message_tag == id_021__psquebec__smart_rollup__outbox__message_tag::atomic_transaction_batch_typed)
- id: whitelist_update
  type: whitelist_update
  if: (id_021__psquebec__smart_rollup__outbox__message_tag == id_021__psquebec__smart_rollup__outbox__message_tag::whitelist_update)
