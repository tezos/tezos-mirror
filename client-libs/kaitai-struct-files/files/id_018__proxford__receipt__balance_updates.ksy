...
types:
  ...
  id_018__proxford__frozen_staker:
    ...
    - id: baker
      ...
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
  id_018__proxford__operation_metadata__alpha__balance_and_update:
    seq:
    - id: id_018__proxford__operation_metadata__alpha__balance_and_update_tag
      type: u1
      enum: id_018__proxford__operation_metadata__alpha__balance_and_update_tag
    - id: contract
      type: contract
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::contract)
    - id: block_fees
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::block_fees)
    - id: deposits
      type: deposits
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::deposits)
    - id: nonce_revelation_rewards
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::nonce_revelation_rewards)
    - id: attesting_rewards
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::attesting_rewards)
    - id: baking_rewards
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::baking_rewards)
    - id: baking_bonuses
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::baking_bonuses)
    - id: storage_fees
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::storage_fees)
    - id: double_signing_punishments
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::double_signing_punishments)
    - id: lost_attesting_rewards
      type: lost_attesting_rewards
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::lost_attesting_rewards)
    - id: liquidity_baking_subsidies
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::liquidity_baking_subsidies)
    - id: burned
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::burned)
    - id: commitments
      type: commitments
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::commitments)
    - id: bootstrap
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::bootstrap)
    - id: invoice
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::invoice)
    - id: initial_commitments
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::initial_commitments)
    - id: minted
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::minted)
    - id: frozen_bonds
      type: frozen_bonds
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::frozen_bonds)
    - id: smart_rollup_refutation_punishments
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::smart_rollup_refutation_punishments)
    - id: smart_rollup_refutation_rewards
      type: id_018__proxford__operation_metadata__alpha__tez_balance_update
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::smart_rollup_refutation_rewards)
    - id: unstaked_deposits
      type: unstaked_deposits
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::unstaked_deposits)
    - id: staking_delegator_numerator
      type: staking_delegator_numerator
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::staking_delegator_numerator)
    - id: staking_delegate_denominator
      type: staking_delegate_denominator
      if: (id_018__proxford__operation_metadata__alpha__balance_and_update_tag ==
        id_018__proxford__operation_metadata__alpha__balance_and_update_tag::staking_delegate_denominator)
  ...
  id_018__proxford__operation_metadata__alpha__balance_updates_entries:
    seq:
    - id: id_018__proxford__operation_metadata__alpha__balance_and_update
      type: id_018__proxford__operation_metadata__alpha__balance_and_update
  ...
  id_018__proxford__operation_metadata__alpha__update_origin:
    ...
    - id: id_018__proxford__operation_metadata__alpha__update_origin_tag
      type: u1
      enum: id_018__proxford__operation_metadata__alpha__update_origin_tag
    - id: delayed_operation
      size: 32
      if: (id_018__proxford__operation_metadata__alpha__update_origin_tag == id_018__proxford__operation_metadata__alpha__update_origin_tag::delayed_operation)
  ...
  staking_delegate_denominator:
    ...
    - id: delegate
      type: public_key_hash
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
    - id: id_018__proxford__operation_metadata__alpha__staking_abstract_quantity
      type: id_018__proxford__operation_metadata__alpha__staking_abstract_quantity
...
enums:
  ...
  id_018__proxford__frozen_staker_tag:
    ...
    1: shared
    2: baker
  id_018__proxford__operation_metadata__alpha__balance_and_update_tag:
    0: contract
    2: block_fees
    4: deposits
  ...
  id_018__proxford__operation_metadata__alpha__update_origin_tag:
    0: block_application
