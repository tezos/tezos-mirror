meta:
  id: seoul__smart_rollup__reveal
  endian: be
doc: ! 'Encoding id: seoul.smart_rollup.reveal'
types:
  input_hash:
    seq:
    - id: input_hash_tag
...
enums:
  ...
  seoul__contract_id_tag:
    0: implicit
    1: originated
  seoul__smart_rollup__reveal_tag:
    0: reveal_raw_data
    1: reveal_metadata
    2: request_dal_page
...
seq:
- id: seoul__smart_rollup__reveal_tag
  type: u1
  enum: seoul__smart_rollup__reveal_tag
- id: reveal_raw_data
  type: input_hash
  if: (seoul__smart_rollup__reveal_tag == seoul__smart_rollup__reveal_tag::reveal_raw_data)
- id: request_dal_page
  type: page_id
  if: (seoul__smart_rollup__reveal_tag == seoul__smart_rollup__reveal_tag::request_dal_page)
- id: request_adaptive_dal_page
  type: request_adaptive_dal_page
  if: (seoul__smart_rollup__reveal_tag == seoul__smart_rollup__reveal_tag::request_adaptive_dal_page)
