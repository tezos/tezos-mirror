meta:
  id: alpha__operation_with_legacy_attestation_name__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: alpha.operation_with_legacy_attestation_name.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  alpha__operation_with_legacy_attestation_name__alpha__contents:
    ...
    - id: dal_publish_commitment
      ...
      if: (alpha__operation_with_legacy_attestation_name__alpha__contents_tag == alpha__operation_with_legacy_attestation_name__alpha__contents_tag::dal_publish_commitment)
    ...
    - id: host
      type: host
      if: (alpha__operation_with_legacy_attestation_name__alpha__contents_tag == alpha__operation_with_legacy_attestation_name__alpha__contents_tag::host)
