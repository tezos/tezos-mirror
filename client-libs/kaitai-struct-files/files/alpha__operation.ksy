...
doc: ! 'Encoding id: alpha.operation'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  alpha__operation__alpha__contents_or_signature_prefix:
    ...
    - id: preattestations_aggregate
      type: preattestations_aggregate
      if: (alpha__operation__alpha__contents_or_signature_prefix_tag == alpha__operation__alpha__contents_or_signature_prefix_tag::preattestations_aggregate)
    - id: double_consensus_operation_evidence
      type: double_consensus_operation_evidence
      if: (alpha__operation__alpha__contents_or_signature_prefix_tag == alpha__operation__alpha__contents_or_signature_prefix_tag::double_consensus_operation_evidence)
    ...
    - id: update_companion_key
      ...
      if: (alpha__operation__alpha__contents_or_signature_prefix_tag == alpha__operation__alpha__contents_or_signature_prefix_tag::update_companion_key)
    - id: drain_delegate
      type: drain_delegate
