...
types:
  ...
  id_016__ptmumbai__big_map_id:
    seq:
    - id: id_016__ptmumbai__big_map_id
      type: z
  id_016__ptmumbai__lazy_storage_diff:
    seq:
    - id: id_016__ptmumbai__lazy_storage_diff_entries
      type: id_016__ptmumbai__lazy_storage_diff_entries
      repeat: eos
  id_016__ptmumbai__lazy_storage_diff_entries:
    seq:
    - id: id_016__ptmumbai__lazy_storage_diff_elt_tag
      type: u1
      enum: id_016__ptmumbai__lazy_storage_diff_elt_tag
    - id: big_map
      type: big_map
      if: (id_016__ptmumbai__lazy_storage_diff_elt_tag == id_016__ptmumbai__lazy_storage_diff_elt_tag::big_map)
    - id: sapling_state
      type: sapling_state
      if: (id_016__ptmumbai__lazy_storage_diff_elt_tag == id_016__ptmumbai__lazy_storage_diff_elt_tag::sapling_state)
  ...
  id_016__ptmumbai__sapling_state_id:
    seq:
    - id: id_016__ptmumbai__sapling_state_id
      type: z
...
enums:
  ...
  diff_tag:
    ...
    2: copy
    3: alloc
  id_016__ptmumbai__lazy_storage_diff_elt_tag:
    0: big_map
    1: sapling_state
  id_016__ptmumbai__michelson__v1__primitives:
    0: parameter
...
- id: len_id_016__ptmumbai__lazy_storage_diff
  ...
  valid:
    max: 1073741823
- id: id_016__ptmumbai__lazy_storage_diff
  type: id_016__ptmumbai__lazy_storage_diff
