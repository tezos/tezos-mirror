meta:
  id: id_025__psgxqmsv__smart_rollup__wasm_2_0_0__output__proof
  endian: be
doc: ! 'Encoding id: 025-PsGXQmSv.smart_rollup.wasm_2_0_0.output.proof'
types:
  args:
    seq:
    - id: args_entries
  ...
  case_3:
    ...
    - id: case_3_field3
      type: tree_encoding
  id_025__psgxqmsv__contract_id__originated:
    seq:
    - id: id_025__psgxqmsv__contract_id__originated_tag
      type: u1
      enum: id_025__psgxqmsv__contract_id__originated_tag
    - id: originated
      type: originated
      if: (id_025__psgxqmsv__contract_id__originated_tag == id_025__psgxqmsv__contract_id__originated_tag::originated)
  ...
  transactions_entries:
    ...
    - id: parameters
      type: micheline__025__psgxqmsv__michelson_v1__expression
    - id: destination
      type: id_025__psgxqmsv__contract_id__originated
      doc: ! >-
...
enums:
  bool:
    0: false
    255: true
  id_025__psgxqmsv__contract_id__originated_tag:
    1: originated
  id_025__psgxqmsv__michelson__v1__primitives:
    0: parameter
    1: storage
