...
types:
  ...
  copy:
    ...
    - id: destination_big_map
      type: z
  id_008__ptedo2zk__contract__big_map_diff:
    seq:
    - id: id_008__ptedo2zk__contract__big_map_diff_entries
...
enums:
  ...
  micheline__008__ptedo2zk__michelson_v1__expression_tag:
    ...
    10: bytes
seq:
- id: len_id_008__ptedo2zk__contract__big_map_diff
  type: u4be
  valid:
    max: 1073741823
- id: id_008__ptedo2zk__contract__big_map_diff
  type: id_008__ptedo2zk__contract__big_map_diff
  size: len_id_008__ptedo2zk__contract__big_map_diff
