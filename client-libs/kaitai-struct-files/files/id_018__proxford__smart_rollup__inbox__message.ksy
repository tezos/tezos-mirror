meta:
  id: id_018__proxford__smart_rollup__inbox__message
  endian: be
  imports:
  - timestamp__protocol
doc: ! 'Encoding id: 018-Proxford.smart_rollup.inbox.message'
types:
  args:
    seq:
    - id: args_entries
...
enums:
  id_018__proxford__michelson__v1__primitives:
    ...
    156:
      id: nat_0
      doc: NAT
  id_018__proxford__smart_rollup__inbox__message_tag:
    0: internal
    1: external
  internal_tag:
    0: transfer
  ...
  public_key_hash_tag:
    ...
    3: bls
seq:
- id: id_018__proxford__smart_rollup__inbox__message_tag
  type: u1
  enum: id_018__proxford__smart_rollup__inbox__message_tag
- id: internal
  type: internal
  if: (id_018__proxford__smart_rollup__inbox__message_tag == id_018__proxford__smart_rollup__inbox__message_tag::internal)
- id: external
  size-eos: true
  if: (id_018__proxford__smart_rollup__inbox__message_tag == id_018__proxford__smart_rollup__inbox__message_tag::external)
