meta:
  id: id_021__psquebec__operation
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 021-PsQuebec.operation'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_021__psquebec__operation__alpha__contents_or_signature_prefix:
    ...
    - id: id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag
      type: u1
      enum: id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag
    - id: signature_prefix
      type: bls_signature_prefix
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::signature_prefix)
      doc: The prefix of a BLS signature, i.e. the first 32 bytes.
    - id: preattestation
      type: preattestation
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::preattestation)
    - id: attestation
      type: attestation
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::attestation)
    - id: attestation_with_dal
      type: attestation_with_dal
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::attestation_with_dal)
    - id: double_preattestation_evidence
      type: double_preattestation_evidence
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::double_preattestation_evidence)
    - id: double_attestation_evidence
      type: double_attestation_evidence
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::double_attestation_evidence)
    ...
    - id: vdf_revelation
      type: solution
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::vdf_revelation)
    - id: double_baking_evidence
      type: double_baking_evidence
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::double_baking_evidence)
    - id: activate_account
      type: activate_account
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::activate_account)
    - id: proposals
      type: proposals_1
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::proposals)
    - id: ballot
      type: ballot
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::ballot)
    - id: reveal
      type: reveal
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::reveal)
    - id: transaction
      type: transaction
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::transaction)
    - id: origination
      type: origination
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::origination)
    - id: delegation
      type: delegation
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::delegation)
    - id: set_deposits_limit
      type: set_deposits_limit
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::set_deposits_limit)
    - id: increase_paid_storage
      type: increase_paid_storage
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::increase_paid_storage)
    ...
    - id: drain_delegate
      type: drain_delegate
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::drain_delegate)
    - id: failing_noop
      type: bytes_dyn_uint30
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::failing_noop)
    - id: register_global_constant
      type: register_global_constant
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::register_global_constant)
    - id: transfer_ticket
      type: transfer_ticket
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::transfer_ticket)
    - id: dal_publish_commitment
      type: dal_publish_commitment
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::dal_publish_commitment)
    - id: smart_rollup_originate
      type: smart_rollup_originate
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_originate)
    - id: smart_rollup_add_messages
      type: smart_rollup_add_messages
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_add_messages)
    - id: smart_rollup_cement
      type: smart_rollup_cement
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_cement)
    - id: smart_rollup_publish
      type: smart_rollup_publish
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_publish)
    - id: smart_rollup_refute
      type: smart_rollup_refute
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_refute)
    ...
    - id: smart_rollup_execute_outbox_message
      ...
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_execute_outbox_message)
    - id: smart_rollup_recover_bond
      type: smart_rollup_recover_bond
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_recover_bond)
    - id: zk_rollup_origination
      type: zk_rollup_origination
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::zk_rollup_origination)
    - id: zk_rollup_publish
      type: zk_rollup_publish
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::zk_rollup_publish)
    - id: zk_rollup_update
      type: zk_rollup_update
      if: (id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag ==
        id_021__psquebec__operation__alpha__contents_or_signature_prefix_tag::zk_rollup_update)
