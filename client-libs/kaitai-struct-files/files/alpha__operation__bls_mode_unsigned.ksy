meta:
  id: alpha__operation__bls_mode_unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: alpha.operation.bls_mode_unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  alpha__mutez:
    ...
    - id: alpha__mutez
      type: n
  alpha__operation__alpha__bls_mode_contents:
    seq:
    - id: alpha__operation__alpha__bls_mode_contents_tag
      type: u1
      enum: alpha__operation__alpha__bls_mode_contents_tag
    ...
    - id: vdf_revelation
      type: solution
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::vdf_revelation)
    - id: double_baking_evidence
      type: double_baking_evidence
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::double_baking_evidence)
    - id: dal_entrapment_evidence
      type: dal_entrapment_evidence
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::dal_entrapment_evidence)
    - id: activate_account
      type: activate_account
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::activate_account)
    - id: proposals
      type: proposals_1
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::proposals)
    - id: ballot
      type: ballot
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::ballot)
    - id: reveal
      type: reveal
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::reveal)
    - id: transaction
      type: transaction
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::transaction)
    - id: origination
      type: origination
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::origination)
    - id: delegation
      type: delegation
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::delegation)
    - id: set_deposits_limit
      type: set_deposits_limit
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::set_deposits_limit)
    - id: increase_paid_storage
      type: increase_paid_storage
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::increase_paid_storage)
    - id: update_consensus_key
      type: update_consensus_key
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::update_consensus_key)
    ...
    - id: drain_delegate
      type: drain_delegate
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::drain_delegate)
    - id: failing_noop
      type: bytes_dyn_uint30
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::failing_noop)
    - id: register_global_constant
      type: register_global_constant
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::register_global_constant)
    - id: transfer_ticket
      type: transfer_ticket
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::transfer_ticket)
    - id: dal_publish_commitment
      type: dal_publish_commitment
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::dal_publish_commitment)
    - id: smart_rollup_originate
      type: smart_rollup_originate
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_originate)
    - id: smart_rollup_add_messages
      type: smart_rollup_add_messages
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_add_messages)
    - id: smart_rollup_cement
      type: smart_rollup_cement
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_cement)
    - id: smart_rollup_publish
      type: smart_rollup_publish
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_publish)
    - id: smart_rollup_refute
      type: smart_rollup_refute
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_refute)
    - id: smart_rollup_timeout
      type: smart_rollup_timeout
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_timeout)
    - id: smart_rollup_execute_outbox_message
      type: smart_rollup_execute_outbox_message
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_execute_outbox_message)
    - id: smart_rollup_recover_bond
      type: smart_rollup_recover_bond
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::smart_rollup_recover_bond)
    - id: zk_rollup_origination
      type: zk_rollup_origination
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::zk_rollup_origination)
    - id: zk_rollup_publish
      type: zk_rollup_publish
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::zk_rollup_publish)
    - id: zk_rollup_update
      type: zk_rollup_update
      if: (alpha__operation__alpha__bls_mode_contents_tag == alpha__operation__alpha__bls_mode_contents_tag::zk_rollup_update)
  alpha__operation__alpha__bls_mode_unsigned_operation:
    seq:
    - id: alpha__operation__alpha__bls_mode_unsigned_operation
      type: operation__shell_header
    - id: contents
  ...
  contents_entries:
    seq:
    - id: alpha__operation__alpha__bls_mode_contents
      type: alpha__operation__alpha__bls_mode_contents
  dal__page__proof:
    seq:
    - id: dal_page_id
      type: dal_page_id
...
seq:
- id: alpha__operation__alpha__bls_mode_unsigned_operation
  type: alpha__operation__alpha__bls_mode_unsigned_operation
