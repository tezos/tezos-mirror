meta:
  id: id_017__ptnairob__operation__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 017-PtNairob.operation.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  contents_entries:
    seq:
    - id: id_017__ptnairob__operation__alpha__contents
      type: id_017__ptnairob__operation__alpha__contents
  dal__page__proof:
    seq:
    - id: dal_page_id
      type: dal_page_id
  ...
  id_017__ptnairob__operation__alpha__unsigned_operation:
    seq:
    - id: id_017__ptnairob__operation__alpha__unsigned_operation
      type: operation__shell_header
    - id: contents
...
seq:
- id: id_017__ptnairob__operation__alpha__unsigned_operation
  type: id_017__ptnairob__operation__alpha__unsigned_operation
