meta:
  id: id_021__psquebec__operation__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 021-PsQuebec.operation.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_021__psquebec__operation__alpha__unsigned_operation:
    seq:
...
seq:
- id: id_021__psquebec__operation__alpha__unsigned_operation
  type: id_021__psquebec__operation__alpha__unsigned_operation
