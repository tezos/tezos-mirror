...
types:
  ...
  id_021__psquebec__apply_internal_results__alpha__operation_result:
    seq:
    - id: source
      type: id_021__psquebec__transaction_destination
      doc: ! >-
    ...
    - id: nonce
      type: u2be
    - id: id_021__psquebec__apply_internal_results__alpha__operation_result_tag
      type: u1
      enum: id_021__psquebec__apply_internal_results__alpha__operation_result_tag
    - id: transaction
      type: transaction
      if: (id_021__psquebec__apply_internal_results__alpha__operation_result_tag ==
        id_021__psquebec__apply_internal_results__alpha__operation_result_tag::transaction)
    - id: origination
      type: origination
      if: (id_021__psquebec__apply_internal_results__alpha__operation_result_tag ==
        id_021__psquebec__apply_internal_results__alpha__operation_result_tag::origination)
    - id: delegation
      type: delegation
      if: (id_021__psquebec__apply_internal_results__alpha__operation_result_tag ==
        id_021__psquebec__apply_internal_results__alpha__operation_result_tag::delegation)
    - id: event
      type: event
      if: (id_021__psquebec__apply_internal_results__alpha__operation_result_tag ==
        id_021__psquebec__apply_internal_results__alpha__operation_result_tag::event)
  ...
  id_021__psquebec__scripted__contracts:
    ...
    - id: storage
      type: bytes_dyn_uint30
  id_021__psquebec__transaction_destination:
    seq:
    - id: id_021__psquebec__transaction_destination_tag
      type: u1
      enum: id_021__psquebec__transaction_destination_tag
    - id: implicit
      type: public_key_hash
      if: (id_021__psquebec__transaction_destination_tag == id_021__psquebec__transaction_destination_tag::implicit)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
    - id: originated
      type: originated
      if: (id_021__psquebec__transaction_destination_tag == id_021__psquebec__transaction_destination_tag::originated)
    - id: smart_rollup
      type: smart_rollup
      if: (id_021__psquebec__transaction_destination_tag == id_021__psquebec__transaction_destination_tag::smart_rollup)
    - id: zk_rollup
      type: zk_rollup
      if: (id_021__psquebec__transaction_destination_tag == id_021__psquebec__transaction_destination_tag::zk_rollup)
...
- id: id_021__psquebec__apply_internal_results__alpha__operation_result
  type: id_021__psquebec__apply_internal_results__alpha__operation_result
