...
types:
  ...
  id_008__ptedo2zk__operation_metadata__alpha__balance_update:
    seq:
    - id: change
      type: s8be
  id_008__ptedo2zk__operation_metadata__alpha__balance_updates:
    ...
    - id: id_008__ptedo2zk__operation_metadata__alpha__balance_updates_entries
      ...
      repeat: eos
  id_008__ptedo2zk__operation_metadata__alpha__balance_updates_0:
    seq:
  ...
  id_008__ptedo2zk__operation_metadata__alpha__balance_updates_entries:
    ...
    - id: id_008__ptedo2zk__operation_metadata__alpha__balance_update
      type: id_008__ptedo2zk__operation_metadata__alpha__balance_update
  originated:
    seq:
    - id: contract_hash
      size: 20
...
seq:
- id: id_008__ptedo2zk__operation_metadata__alpha__balance_updates
  type: id_008__ptedo2zk__operation_metadata__alpha__balance_updates_0
