meta:
  id: id_017__ptnairob__smart_rollup__outbox__message
  endian: be
doc: ! 'Encoding id: 017-PtNairob.smart_rollup.outbox.message'
types:
  args:
    seq:
    - id: args_entries
...
enums:
  ...
  id_017__ptnairob__michelson__v1__primitives:
    ...
    156:
      id: nat_0
      doc: NAT
  id_017__ptnairob__smart_rollup__outbox__message_tag:
  ...
  micheline__017__ptnairob__michelson_v1__expression_tag:
    ...
    10: bytes
seq:
- id: id_017__ptnairob__smart_rollup__outbox__message_tag
  type: u1
  enum: id_017__ptnairob__smart_rollup__outbox__message_tag
- id: atomic_transaction_batch
  type: transactions_0
  if: (id_017__ptnairob__smart_rollup__outbox__message_tag == id_017__ptnairob__smart_rollup__outbox__message_tag::atomic_transaction_batch)
- id: atomic_transaction_batch_typed
  type: transactions_2
  if: (id_017__ptnairob__smart_rollup__outbox__message_tag == id_017__ptnairob__smart_rollup__outbox__message_tag::atomic_transaction_batch_typed)
