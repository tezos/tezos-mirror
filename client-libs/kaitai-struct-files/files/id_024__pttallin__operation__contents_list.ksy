meta:
  id: id_024__pttallin__operation__contents_list
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 024-PtTALLiN.operation.contents_list'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_024__pttallin__operation__contents_list_entries:
    seq:
...
enums:
  ...
  step_tag:
    ...
    1: proof
seq:
- id: id_024__pttallin__operation__contents_list_entries
  type: id_024__pttallin__operation__contents_list_entries
  repeat: eos
