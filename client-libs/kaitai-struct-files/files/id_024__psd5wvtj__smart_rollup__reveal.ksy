meta:
  id: id_024__psd5wvtj__smart_rollup__reveal
  endian: be
doc: ! 'Encoding id: 024-PsD5wVTJ.smart_rollup.reveal'
types:
  ...
  some_entries:
    seq:
    - id: id_024__psd5wvtj__contract_id
...
enums:
  id_024__psd5wvtj__contract_id_tag:
    0: implicit
    1: originated
  id_024__psd5wvtj__smart_rollup__reveal_tag:
    0: reveal_raw_data
    1: reveal_metadata
    2: request_dal_page
...
- id: id_024__psd5wvtj__smart_rollup__reveal_tag
  type: u1
  enum: id_024__psd5wvtj__smart_rollup__reveal_tag
- id: reveal_raw_data
  type: input_hash
  if: (id_024__psd5wvtj__smart_rollup__reveal_tag == id_024__psd5wvtj__smart_rollup__reveal_tag::reveal_raw_data)
- id: request_dal_page
  type: page_id
  if: (id_024__psd5wvtj__smart_rollup__reveal_tag == id_024__psd5wvtj__smart_rollup__reveal_tag::request_dal_page)
- id: request_adaptive_dal_page
  type: request_adaptive_dal_page
  if: (id_024__psd5wvtj__smart_rollup__reveal_tag == id_024__psd5wvtj__smart_rollup__reveal_tag::request_adaptive_dal_page)
