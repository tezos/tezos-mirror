...
types:
  ...
  big_map:
    seq:
    - id: id
      type: id_015__ptlimapt__big_map_id
  ...
  copy_0:
    seq:
    - id: source
      type: id_015__ptlimapt__sapling_state_id
  ...
  diff_0:
    ...
    - id: alloc
      type: alloc_0
      if: (diff_tag == diff_tag::alloc)
  id_015__ptlimapt__big_map_id:
    seq:
    - id: id_015__ptlimapt__big_map_id
      type: z
  id_015__ptlimapt__lazy_storage_diff:
    seq:
    - id: id_015__ptlimapt__lazy_storage_diff_entries
      type: id_015__ptlimapt__lazy_storage_diff_entries
      repeat: eos
  id_015__ptlimapt__lazy_storage_diff_entries:
    seq:
    - id: id_015__ptlimapt__lazy_storage_diff_elt_tag
      type: u1
      enum: id_015__ptlimapt__lazy_storage_diff_elt_tag
    - id: big_map
      type: big_map
      if: (id_015__ptlimapt__lazy_storage_diff_elt_tag == id_015__ptlimapt__lazy_storage_diff_elt_tag::big_map)
    - id: sapling_state
      type: sapling_state
      if: (id_015__ptlimapt__lazy_storage_diff_elt_tag == id_015__ptlimapt__lazy_storage_diff_elt_tag::sapling_state)
  ...
  id_015__ptlimapt__sapling_state_id:
    seq:
    - id: id_015__ptlimapt__sapling_state_id
      type: z
...
enums:
  ...
  diff_tag:
    ...
    2: copy
    3: alloc
  id_015__ptlimapt__lazy_storage_diff_elt_tag:
    0: big_map
    1: sapling_state
  id_015__ptlimapt__michelson__v1__primitives:
    0: parameter
  ...
  micheline__015__ptlimapt__michelson_v1__expression_tag:
    ...
    10: bytes
seq:
- id: len_id_015__ptlimapt__lazy_storage_diff
  type: u4
  valid:
    max: 1073741823
- id: id_015__ptlimapt__lazy_storage_diff
  type: id_015__ptlimapt__lazy_storage_diff
  size: len_id_015__ptlimapt__lazy_storage_diff
