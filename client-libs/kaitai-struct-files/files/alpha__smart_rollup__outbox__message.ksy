meta:
  id: alpha__smart_rollup__outbox__message
  endian: be
doc: ! 'Encoding id: alpha.smart_rollup.outbox.message'
types:
...
enums:
  ...
  public_key_hash_tag:
    ...
    3: bls
seq:
- id: alpha__smart_rollup__outbox__message_tag
  type: u1
  enum: alpha__smart_rollup__outbox__message_tag
- id: atomic_transaction_batch
  type: transactions_0
  if: (alpha__smart_rollup__outbox__message_tag == alpha__smart_rollup__outbox__message_tag::atomic_transaction_batch)
- id: atomic_transaction_batch_typed
  type: transactions_2
  if: (alpha__smart_rollup__outbox__message_tag == alpha__smart_rollup__outbox__message_tag::atomic_transaction_batch_typed)
- id: whitelist_update
  type: whitelist_update
  if: (alpha__smart_rollup__outbox__message_tag == alpha__smart_rollup__outbox__message_tag::whitelist_update)
