...
types:
  ...
  copy:
    ...
    - id: destination_big_map
      type: z
  id_005__psbabym1__contract__big_map_diff:
    seq:
    - id: id_005__psbabym1__contract__big_map_diff_entries
...
enums:
  ...
  micheline__005__psbabym1__michelson_v1__expression_tag:
    ...
    10: bytes
seq:
- id: len_id_005__psbabym1__contract__big_map_diff
  type: u4
  valid:
    max: 1073741823
- id: id_005__psbabym1__contract__big_map_diff
  type: id_005__psbabym1__contract__big_map_diff
  size: len_id_005__psbabym1__contract__big_map_diff
