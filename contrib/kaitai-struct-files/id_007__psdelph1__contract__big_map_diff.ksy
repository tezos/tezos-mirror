...
types:
  id_007__psdelph1__contract__big_map_diff_entries:
    ...
    - id: id_007__psdelph1__contract__big_map_diff_elt_update
      type: id_007__psdelph1__contract__big_map_diff_elt_update
      if: (id_007__psdelph1__contract__big_map_diff_elt_tag == id_007__psdelph1__contract__big_map_diff_elt_tag::update)
    - id: id_007__psdelph1__contract__big_map_diff_elt_remove
      type: z
      if: (id_007__psdelph1__contract__big_map_diff_elt_tag == id_007__psdelph1__contract__big_map_diff_elt_tag::remove)
    - id: id_007__psdelph1__contract__big_map_diff_elt_copy
      type: id_007__psdelph1__contract__big_map_diff_elt_copy
      if: (id_007__psdelph1__contract__big_map_diff_elt_tag == id_007__psdelph1__contract__big_map_diff_elt_tag::copy)
    - id: id_007__psdelph1__contract__big_map_diff_elt_alloc
      type: id_007__psdelph1__contract__big_map_diff_elt_alloc
      if: (id_007__psdelph1__contract__big_map_diff_elt_tag == id_007__psdelph1__contract__big_map_diff_elt_tag::alloc)
  id_007__psdelph1__contract__big_map_diff_elt_alloc:
    seq:
    - id: big_map
      type: z
    - id: key_type
    ...
    - id: value_type
      type: micheline__007__psdelph1__michelson_v1__expression
  id_007__psdelph1__contract__big_map_diff_elt_copy:
    seq:
    - id: source_big_map
      type: z
    - id: destination_big_map
      type: z
  id_007__psdelph1__contract__big_map_diff_elt_update:
    seq:
    - id: big_map
      type: z
    - id: key_hash
