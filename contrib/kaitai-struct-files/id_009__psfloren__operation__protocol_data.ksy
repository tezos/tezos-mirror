meta:
  id: id_009__psfloren__operation__protocol_data
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 009-PsFLoren.operation.protocol_data'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_009__psfloren__operation__alpha__contents_and_signature:
    seq:
    - id: contents
...
enums:
  ...
  public_key_tag:
    ...
    2: p256
seq:
- id: id_009__psfloren__operation__alpha__contents_and_signature
  type: id_009__psfloren__operation__alpha__contents_and_signature
