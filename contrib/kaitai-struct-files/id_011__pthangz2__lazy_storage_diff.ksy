...
types:
  ...
  big_map:
    seq:
    - id: id
      type: id_011__pthangz2__big_map_id
  ...
  copy_0:
    seq:
    - id: source
      type: id_011__pthangz2__sapling_state_id
  ...
  diff_0:
    ...
    - id: alloc
      type: alloc_0
      if: (diff_tag == diff_tag::alloc)
  id_011__pthangz2__big_map_id:
    seq:
    - id: id_011__pthangz2__big_map_id
      type: z
  id_011__pthangz2__lazy_storage_diff:
    seq:
    - id: id_011__pthangz2__lazy_storage_diff_entries
  ...
  id_011__pthangz2__sapling_state_id:
    seq:
    - id: id_011__pthangz2__sapling_state_id
      type: z
...
- id: len_id_011__pthangz2__lazy_storage_diff
  ...
  valid:
    max: 1073741823
- id: id_011__pthangz2__lazy_storage_diff
  type: id_011__pthangz2__lazy_storage_diff
