meta:
  id: alpha__smart_rollup__inbox__message
  endian: be
  imports:
  - timestamp__protocol
doc: ! 'Encoding id: alpha.smart_rollup.inbox.message'
types:
...
- id: alpha__smart_rollup__inbox__message_tag
  type: u1
  enum: alpha__smart_rollup__inbox__message_tag
- id: internal
  type: internal
  if: (alpha__smart_rollup__inbox__message_tag == alpha__smart_rollup__inbox__message_tag::internal)
- id: external
  size-eos: true
  if: (alpha__smart_rollup__inbox__message_tag == alpha__smart_rollup__inbox__message_tag::external)
