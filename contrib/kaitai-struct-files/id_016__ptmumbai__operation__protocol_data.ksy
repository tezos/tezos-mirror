meta:
  id: id_016__ptmumbai__operation__protocol_data
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 016-PtMumbai.operation.protocol_data'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  contents_and_signature_prefix_entries:
    seq:
    - id: id_016__ptmumbai__operation__alpha__contents_or_signature_prefix
      type: id_016__ptmumbai__operation__alpha__contents_or_signature_prefix
  dal__page__proof:
    seq:
    - id: dal_page_id
      type: dal_page_id
  ...
  id_016__ptmumbai__operation__alpha__contents_and_signature:
    ...
    - id: signature_suffix
      size: 64
  id_016__ptmumbai__operation__alpha__contents_or_signature_prefix:
    seq:
    - id: id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag
      type: u1
      enum: id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag
    - id: signature_prefix
      type: bls_signature_prefix
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::signature_prefix)
      doc: The prefix of a BLS signature, i.e. the first 32 bytes.
    - id: endorsement
      type: endorsement
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::endorsement)
    - id: preendorsement
      type: preendorsement
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::preendorsement)
    - id: dal_attestation
      type: dal_attestation
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::dal_attestation)
    - id: seed_nonce_revelation
      type: seed_nonce_revelation
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::seed_nonce_revelation)
    - id: vdf_revelation
      type: solution
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::vdf_revelation)
    - id: double_endorsement_evidence
      type: double_endorsement_evidence
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::double_endorsement_evidence)
    - id: double_preendorsement_evidence
      type: double_preendorsement_evidence
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::double_preendorsement_evidence)
    - id: double_baking_evidence
      type: double_baking_evidence
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::double_baking_evidence)
    - id: activate_account
      type: activate_account
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::activate_account)
    - id: proposals
      type: proposals_1
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::proposals)
    - id: ballot
      type: ballot
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::ballot)
    - id: reveal
      type: reveal
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::reveal)
    - id: transaction
      type: transaction
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::transaction)
    - id: origination
      type: origination
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::origination)
    - id: delegation
      type: delegation
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::delegation)
    - id: set_deposits_limit
      type: set_deposits_limit
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::set_deposits_limit)
    - id: increase_paid_storage
      type: increase_paid_storage
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::increase_paid_storage)
    - id: update_consensus_key
      type: update_consensus_key
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::update_consensus_key)
    - id: drain_delegate
      type: drain_delegate
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::drain_delegate)
    - id: failing_noop
      type: arbitrary
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::failing_noop)
    - id: register_global_constant
      type: register_global_constant
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::register_global_constant)
    - id: tx_rollup_origination
      type: tx_rollup_origination
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_origination)
    - id: tx_rollup_submit_batch
      type: tx_rollup_submit_batch
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_submit_batch)
    - id: tx_rollup_commit
      type: tx_rollup_commit
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_commit)
    - id: tx_rollup_return_bond
      type: tx_rollup_return_bond
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_return_bond)
    - id: tx_rollup_finalize_commitment
      type: tx_rollup_finalize_commitment
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_finalize_commitment)
    - id: tx_rollup_remove_commitment
      type: tx_rollup_remove_commitment
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_remove_commitment)
    - id: tx_rollup_rejection
      type: tx_rollup_rejection
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_rejection)
    - id: tx_rollup_dispatch_tickets
      type: tx_rollup_dispatch_tickets
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::tx_rollup_dispatch_tickets)
    - id: transfer_ticket
      type: transfer_ticket
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::transfer_ticket)
    - id: dal_publish_slot_header
      type: dal_publish_slot_header
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::dal_publish_slot_header)
    - id: smart_rollup_originate
      type: smart_rollup_originate
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_originate)
    - id: smart_rollup_add_messages
      type: smart_rollup_add_messages
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_add_messages)
    - id: smart_rollup_cement
      type: smart_rollup_cement
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_cement)
    - id: smart_rollup_publish
      type: smart_rollup_publish
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_publish)
    - id: smart_rollup_refute
      type: smart_rollup_refute
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_refute)
    - id: smart_rollup_timeout
      type: smart_rollup_timeout
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_timeout)
    - id: smart_rollup_execute_outbox_message
      type: smart_rollup_execute_outbox_message
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_execute_outbox_message)
    - id: smart_rollup_recover_bond
      type: smart_rollup_recover_bond
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::smart_rollup_recover_bond)
    - id: zk_rollup_origination
      type: zk_rollup_origination
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::zk_rollup_origination)
    - id: zk_rollup_publish
      type: zk_rollup_publish
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::zk_rollup_publish)
    - id: zk_rollup_update
      type: zk_rollup_update
      if: (id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag ==
        id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag::zk_rollup_update)
...
enums:
  ...
  id_016__ptmumbai__michelson__v1__primitives:
    ...
    156:
      id: nat_0
      doc: NAT
  id_016__ptmumbai__operation__alpha__contents_or_signature_prefix_tag:
  ...
  step_tag:
    ...
    1: proof
seq:
- id: id_016__ptmumbai__operation__alpha__contents_and_signature
  type: id_016__ptmumbai__operation__alpha__contents_and_signature
