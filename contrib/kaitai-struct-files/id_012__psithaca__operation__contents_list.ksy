meta:
  id: id_012__psithaca__operation__contents_list
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 012-Psithaca.operation.contents_list'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_012__psithaca__operation__contents_list_entries:
    seq:
...
enums:
  ...
  public_key_tag:
    ...
    2: p256
seq:
- id: id_012__psithaca__operation__contents_list_entries
  type: id_012__psithaca__operation__contents_list_entries
  repeat: eos
