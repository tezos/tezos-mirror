meta:
  id: alpha__operation__contents_list
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: alpha.operation.contents_list'
types:
  activate_account:
    seq:
    - id: pkh
...
enums:
  ...
  step_tag:
    ...
    1: proof
seq:
- id: alpha__operation__contents_list_entries
  type: alpha__operation__contents_list_entries
  repeat: eos
