meta:
  id: id_018__proxford__operation__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 018-Proxford.operation.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_018__proxford__inlined__endorsement:
    ...
    - id: operations
      type: id_018__proxford__inlined__endorsement_mempool__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
  ...
  id_018__proxford__inlined__endorsement_mempool__contents:
    seq:
  ...
  id_018__proxford__inlined__preendorsement:
    ...
    - id: id_018__proxford__inlined__preendorsement
      type: operation__shell_header
    - id: operations
      type: id_018__proxford__inlined__preendorsement__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
      size-eos: true
      if: (signature_tag == bool::true)
  id_018__proxford__inlined__preendorsement__contents:
    seq:
  ...
  id_018__proxford__operation_with_legacy_attestation_name__alpha__contents:
    ...
    - id: double_preendorsement_evidence
      ...
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::double_preendorsement_evidence)
    - id: double_endorsement_evidence
      type: double_endorsement_evidence
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::double_endorsement_evidence)
    - id: dal_attestation
      type: dal_attestation
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::dal_attestation)
    - id: seed_nonce_revelation
      type: seed_nonce_revelation
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::seed_nonce_revelation)
    - id: vdf_revelation
      type: solution
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::vdf_revelation)
    - id: double_baking_evidence
      type: double_baking_evidence
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::double_baking_evidence)
    - id: activate_account
    ...
    - id: ballot
      type: ballot
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::ballot)
    - id: reveal
      type: reveal
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::reveal)
    - id: transaction
      type: transaction
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::transaction)
    - id: origination
      type: origination
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::origination)
    - id: delegation
      type: delegation
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::delegation)
    - id: set_deposits_limit
      type: set_deposits_limit
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::set_deposits_limit)
    - id: increase_paid_storage
      type: increase_paid_storage
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::increase_paid_storage)
    - id: update_consensus_key
      type: update_consensus_key
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
        == id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag::update_consensus_key)
    - id: drain_delegate
      type: drain_delegate
      if: (id_018__proxford__operation_with_legacy_attestation_name__alpha__contents_tag
  ...
  id_018__proxford__operation_with_legacy_attestation_name__alpha__unsigned_operation:
    seq:
    - id: id_018__proxford__operation_with_legacy_attestation_name__alpha__unsigned_operation
      type: operation__shell_header
    - id: contents
...
seq:
- id: id_018__proxford__operation_with_legacy_attestation_name__alpha__unsigned_operation
  type: id_018__proxford__operation_with_legacy_attestation_name__alpha__unsigned_operation
