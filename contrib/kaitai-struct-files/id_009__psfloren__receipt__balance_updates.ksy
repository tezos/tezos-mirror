...
types:
  ...
  id_009__psfloren__operation_metadata__alpha__balance:
    ...
    - id: id_009__psfloren__operation_metadata__alpha__balance_contract
    ...
    - id: id_009__psfloren__operation_metadata__alpha__balance_rewards
      type: id_009__psfloren__operation_metadata__alpha__balance_rewards
    ...
    - id: id_009__psfloren__operation_metadata__alpha__balance_fees
      type: id_009__psfloren__operation_metadata__alpha__balance_fees
    ...
    - id: id_009__psfloren__operation_metadata__alpha__balance_deposits
      type: id_009__psfloren__operation_metadata__alpha__balance_deposits
  ...
  id_009__psfloren__operation_metadata__alpha__balance_deposits:
    seq:
    - id: delegate
      type: public_key_hash
    - id: cycle
      type: s4
  id_009__psfloren__operation_metadata__alpha__balance_fees:
    seq:
    - id: delegate
      type: public_key_hash
    - id: cycle
      type: s4
  id_009__psfloren__operation_metadata__alpha__balance_rewards:
    seq:
    - id: delegate
      type: public_key_hash
    - id: cycle
