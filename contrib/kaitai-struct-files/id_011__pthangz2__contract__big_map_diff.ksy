...
types:
  ...
  bytes:
    ...
    - id: bytes
      size: len_bytes
  id_011__pthangz2__contract__big_map_diff_elt_alloc:
    seq:
    - id: big_map
      type: z
    - id: key_type
    ...
    - id: value_type
      type: micheline__011__pthangz2__michelson_v1__expression
  id_011__pthangz2__contract__big_map_diff_elt_copy:
    seq:
    - id: source_big_map
      type: z
    - id: destination_big_map
      type: z
  id_011__pthangz2__contract__big_map_diff_elt_update:
    seq:
    - id: big_map
      type: z
    - id: key_hash
  ...
  id_011__pthangz2__contract__big_map_diff_entries:
    ...
    - id: id_011__pthangz2__contract__big_map_diff_elt_update
      type: id_011__pthangz2__contract__big_map_diff_elt_update
      if: (id_011__pthangz2__contract__big_map_diff_elt_tag == id_011__pthangz2__contract__big_map_diff_elt_tag::update)
    - id: id_011__pthangz2__contract__big_map_diff_elt_remove
      type: z
      if: (id_011__pthangz2__contract__big_map_diff_elt_tag == id_011__pthangz2__contract__big_map_diff_elt_tag::remove)
    - id: id_011__pthangz2__contract__big_map_diff_elt_copy
      type: id_011__pthangz2__contract__big_map_diff_elt_copy
      if: (id_011__pthangz2__contract__big_map_diff_elt_tag == id_011__pthangz2__contract__big_map_diff_elt_tag::copy)
    - id: id_011__pthangz2__contract__big_map_diff_elt_alloc
      type: id_011__pthangz2__contract__big_map_diff_elt_alloc
