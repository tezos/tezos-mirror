...
types:
  ...
  id_005__psbabym1__operation__alpha__internal_operation:
    ...
    - id: id_005__psbabym1__operation__alpha__internal_operation_reveal
      type: public_key
    ...
    - id: id_005__psbabym1__operation__alpha__internal_operation_transaction
      type: id_005__psbabym1__operation__alpha__internal_operation_transaction
    ...
    - id: id_005__psbabym1__operation__alpha__internal_operation_origination
      type: id_005__psbabym1__operation__alpha__internal_operation_origination
    ...
    - id: id_005__psbabym1__operation__alpha__internal_operation_delegation
      type: id_005__psbabym1__operation__alpha__internal_operation_delegation
  ...
  id_005__psbabym1__operation__alpha__internal_operation_delegation:
    seq:
    - id: delegate_tag
      type: u1
      enum: bool
  ...
  id_005__psbabym1__operation__alpha__internal_operation_origination:
    seq:
    - id: balance
      type: n
    - id: delegate_tag
  ...
  id_005__psbabym1__operation__alpha__internal_operation_transaction:
    seq:
    - id: amount
      type: n
    - id: destination
