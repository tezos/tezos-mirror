...
types:
  ...
  big_map:
    seq:
    - id: id
      type: id_010__ptgranad__big_map_id
  ...
  copy_0:
    seq:
    - id: source
      type: id_010__ptgranad__sapling_state_id
  ...
  diff_0:
    ...
    - id: alloc
      type: alloc_0
      if: (diff_tag == diff_tag::alloc)
  id_010__ptgranad__big_map_id:
    seq:
    - id: id_010__ptgranad__big_map_id
      type: z
  id_010__ptgranad__lazy_storage_diff:
    seq:
  ...
  id_010__ptgranad__sapling_state_id:
    seq:
    - id: id_010__ptgranad__sapling_state_id
      type: z
  micheline__010__ptgranad__michelson_v1__expression:
    seq:
    - id: micheline__010__ptgranad__michelson_v1__expression_tag
      type: u1
      enum: micheline__010__ptgranad__michelson_v1__expression_tag
    - id: int
      type: z
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::int)
    - id: string
      type: string
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::string)
    - id: sequence
      type: sequence_0
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::sequence)
    - id: prim__no_args__no_annots
      type: id_010__ptgranad__michelson__v1__primitives
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::prim__no_args__no_annots)
    - id: prim__no_args__some_annots
      type: prim__no_args__some_annots
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::prim__no_args__some_annots)
    - id: prim__1_arg__no_annots
      type: prim__1_arg__no_annots
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::prim__1_arg__no_annots)
    - id: prim__1_arg__some_annots
      type: prim__1_arg__some_annots
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::prim__1_arg__some_annots)
    - id: prim__2_args__no_annots
      type: prim__2_args__no_annots
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::prim__2_args__no_annots)
    - id: prim__2_args__some_annots
      type: prim__2_args__some_annots
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::prim__2_args__some_annots)
    - id: prim__generic
      type: prim__generic
      if: (micheline__010__ptgranad__michelson_v1__expression_tag == micheline__010__ptgranad__michelson_v1__expression_tag::prim__generic)
    - id: bytes
      type: bytes
...
enums:
  ...
  diff_tag:
    ...
    2: copy
    3: alloc
  id_010__ptgranad__lazy_storage_diff_elt_tag:
    0: big_map
    1: sapling_state
  id_010__ptgranad__michelson__v1__primitives:
    0: parameter
    ...
    140:
      id: get_and_update
      doc: GET_AND_UPDATE
  micheline__010__ptgranad__michelson_v1__expression_tag:
    0: int
    1: string
    2: sequence
    3:
...
- id: len_id_010__ptgranad__lazy_storage_diff
  type: s4
- id: id_010__ptgranad__lazy_storage_diff
  type: id_010__ptgranad__lazy_storage_diff
  size: len_id_010__ptgranad__lazy_storage_diff
