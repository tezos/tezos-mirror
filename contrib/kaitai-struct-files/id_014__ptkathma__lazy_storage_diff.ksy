...
types:
  ...
  big_map:
    seq:
    - id: id
      type: id_014__ptkathma__big_map_id
  ...
  copy_0:
    seq:
    - id: source
      type: id_014__ptkathma__sapling_state_id
  ...
  diff_0:
    ...
    - id: alloc
      type: alloc_0
      if: (diff_tag == diff_tag::alloc)
  id_014__ptkathma__big_map_id:
    seq:
    - id: id_014__ptkathma__big_map_id
      type: z
  id_014__ptkathma__lazy_storage_diff:
    seq:
    - id: id_014__ptkathma__lazy_storage_diff_entries
  ...
  id_014__ptkathma__sapling_state_id:
    seq:
    - id: id_014__ptkathma__sapling_state_id
      type: z
...
- id: len_id_014__ptkathma__lazy_storage_diff
  type: s4
- id: id_014__ptkathma__lazy_storage_diff
  type: id_014__ptkathma__lazy_storage_diff
