meta:
  id: id_006__pscartha__operation
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 006-PsCARTHA.operation'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_006__pscartha__operation__alpha__contents_and_signature:
    seq:
    - id: contents
...
- id: id_006__pscartha__operation
  type: operation__shell_header
- id: id_006__pscartha__operation__alpha__contents_and_signature
  type: id_006__pscartha__operation__alpha__contents_and_signature
