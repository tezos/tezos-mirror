meta:
  id: id_007__psdelph1__operation__unsigned
  endian: be
  imports:
  - block_header__shell
  - operation__shell_header
doc: ! 'Encoding id: 007-PsDELPH1.operation.unsigned'
types:
  activate_account:
    seq:
    - id: pkh
  ...
  id_007__psdelph1__operation__alpha__unsigned_operation:
    seq:
    - id: id_007__psdelph1__operation__alpha__unsigned_operation
      type: operation__shell_header
    - id: contents
...
seq:
- id: id_007__psdelph1__operation__alpha__unsigned_operation
  type: id_007__psdelph1__operation__alpha__unsigned_operation
