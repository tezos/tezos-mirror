...
(** [may_update_all_bakers_attest_first_level ctxt cycle ~total_number_bakers ~tz4_number_bakers]
    checks whether the [tz4_number_bakers] is greater than a portion of the [total_number_bakers],
...
val may_update_all_bakers_attest_first_level :
  Raw_context.t ->
  Cycle_repr.t ->
  total_number_bakers:int ->
  tz4_number_bakers:int ->
  Raw_context.t Lwt.t
