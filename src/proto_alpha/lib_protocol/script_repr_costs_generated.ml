...
(* fun size1 -> fun size2 -> fun size3 -> (((60. * size1) + (10. * size2)) + (10. * size3)) *)
let cost_DECODING_MICHELINE size1 size2 size3 =
  let v2 = size1 in
  let v1 = size2 in
  let v0 = size3 in
  (v2 * S.safe_int 60) + (v1 * S.safe_int 10) + (v0 * S.safe_int 10)
...
(* fun size1 -> fun size2 -> fun size3 -> (((100. * size1) + (25. * size2)) + (10. * size3)) *)
let cost_ENCODING_MICHELINE size1 size2 size3 =
  let v2 = size1 in
  let v1 = size2 in
  let v0 = size3 in
  (v2 * S.safe_int 100) + (v1 * S.safe_int 25) + (v0 * S.safe_int 10)
