...
alias octez-activate-beta="$client -block genesis activate protocol Pt1vxQvxfksQW13WBfDWc9CF87mw982NKAjGhixUAtVM5mBw2m1 with fitness 1 and key activator and parameters $beta_parameters_file";
