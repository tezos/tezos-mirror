...
alias octez-activate-beta="$client -block genesis activate protocol PtA4NFGxa5mLmPaEAAxAofESvLzZPSJ6GQz66SobecGbnCy3FXE with fitness 1 and key activator and parameters $beta_parameters_file";
