...
alias octez-activate-beta="$client -block genesis activate protocol PsGFMmY2bUAbAebEEAhB5jb99NmgdMvmqG4u35HACDukmR3YwYu with fitness 1 and key activator and parameters $beta_parameters_file";
