...
activate_alpha() {
    ...
    ${client} \
        -block genesis \
        activate protocol PtCarthavAMoXqbjBPVgDCRd5LgT7qqKWUPXnYii3xCaHRBMfHH \
        with fitness 1 \
        and key activator \
...
alias tezos-activate-alpha="$client  -block genesis activate protocol PtCarthavAMoXqbjBPVgDCRd5LgT7qqKWUPXnYii3xCaHRBMfHH with fitness 1 and key activator and parameters $parameters_file --timestamp $(TZ='AAA+1' date +%FT%TZ)" ;
