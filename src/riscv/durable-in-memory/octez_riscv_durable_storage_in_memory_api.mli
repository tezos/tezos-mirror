...
external octez_riscv_durable_in_memory_prove_registry_hash: registry_prove -> bytes = "octez_riscv_durable_in_memory_prove_registry_hash"
external octez_riscv_durable_in_memory_prove_registry_size: registry_prove -> int64 = "octez_riscv_durable_in_memory_prove_registry_size"
external octez_riscv_durable_in_memory_prove_registry_resize: registry_prove -> int64 -> (unit, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_registry_resize"
external octez_riscv_durable_in_memory_prove_registry_copy: registry_prove -> int64 -> int64 -> (unit, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_registry_copy"
external octez_riscv_durable_in_memory_prove_registry_move: registry_prove -> int64 -> int64 -> (unit, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_registry_move"
external octez_riscv_durable_in_memory_prove_registry_clear: registry_prove -> int64 -> (unit, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_registry_clear"
external octez_riscv_durable_in_memory_prove_database_exists: registry_prove -> int64 -> bytes -> (bool, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_database_exists"
external octez_riscv_durable_in_memory_prove_database_set: registry_prove -> int64 -> bytes -> bytes -> (unit, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_database_set"
external octez_riscv_durable_in_memory_prove_database_write: registry_prove -> int64 -> bytes -> int64 -> bytes -> (int64, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_database_write"
external octez_riscv_durable_in_memory_prove_database_read: registry_prove -> int64 -> bytes -> int64 -> int64 -> (bytes, invalid_argument_error) result = "octez_riscv_durable_in_memory_prove_database_read"
