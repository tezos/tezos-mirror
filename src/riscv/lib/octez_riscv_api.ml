...
external octe_riscv_to_imm: mut_state -> state = "octe_riscv_to_imm"
...
external octez_riscv_mut_compute_step_many_with_debug: int64 -> mut_state -> (int -> unit) -> int64 = "octez_riscv_mut_compute_step_many_with_debug"
...
external octez_riscv_mut_reveal_raw_data: mut_state -> string -> unit = "octez_riscv_mut_reveal_raw_data"
