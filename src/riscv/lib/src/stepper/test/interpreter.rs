    ...
    ($(#[$m:meta],)* $name: ident, $path: expr) => {
        test_case!(
            ...
            if $path.contains("rv64u") {
                ...
                panic!("Only user mode is supported");
            }
        );
    };
...
// RV64-MI
// These tests require machine-level privileges. Since switching to the Supervising PVM, these
// privileges are no longer accessible.
test_case!(#[ignore], test_suite_rv64mi_p_access, "rv64mi-p-access");
test_case!(#[ignore], test_suite_rv64mi_p_breakpoint, "rv64mi-p-breakpoint");
test_case!(#[ignore], test_suite_rv64mi_p_csr, "rv64mi-p-csr", Mode::User);
test_case!(#[ignore], test_suite_rv64mi_p_ld_misaligned, "rv64mi-p-ld-misaligned");
test_case!(#[ignore], test_suite_rv64mi_p_lh_misaligned, "rv64mi-p-lh-misaligned");
test_case!(#[ignore], test_suite_rv64mi_p_lw_misaligned, "rv64mi-p-lw-misaligned");
test_case!(#[ignore], test_suite_rv64mi_p_ma_addr, "rv64mi-p-ma_addr");
test_case!(#[ignore], test_suite_rv64mi_p_ma_fetch, "rv64mi-p-ma_fetch");
test_case!(#[ignore], test_suite_rv64mi_p_mcsr, "rv64mi-p-mcsr");
test_case!(#[ignore], test_suite_rv64mi_p_sbreak, "rv64mi-p-sbreak");
test_case!(
    #[ignore],
...
test_case!(#[ignore], test_suite_rv64mi_p_sd_misaligned, "rv64mi-p-sd-misaligned");
test_case!(#[ignore], test_suite_rv64mi_p_sh_misaligned, "rv64mi-p-sh-misaligned");
test_case!(#[ignore], test_suite_rv64mi_p_sw_misaligned, "rv64mi-p-sw-misaligned");
test_case!(#[ignore], test_suite_rv64mi_p_zicntr, "rv64mi-p-zicntr");

// RV64-SI
// These tests require supervisor-level privileges. Since switching to the Supervising PVM, these
// privileges are no longer accessible.
test_case!(#[ignore], test_suite_rv64si_p_csr, "rv64si-p-csr");
test_case!(
...
test_case!(#[ignore], test_suite_rv64si_p_ma_fetch, "rv64si-p-ma_fetch");
test_case!(#[ignore], test_suite_rv64si_p_sbreak, "rv64si-p-sbreak");
test_case!(
    #[ignore],
...
test_case!(#[ignore], test_suite_rv64si_p_wfi, "rv64si-p-wfi");
...
// These tests require setting up virtual memory, which requires supervisor-level privileges. Since
// switching to the Supervising PVM, these privileges are no longer accessible.
test_case!(#[ignore], test_suite_rv64ua_v_amoadd_d, "rv64ua-v-amoadd_d");
test_case!(#[ignore], test_suite_rv64ua_v_amoadd_w, "rv64ua-v-amoadd_w");
test_case!(#[ignore], test_suite_rv64ua_v_amoand_d, "rv64ua-v-amoand_d");
test_case!(#[ignore], test_suite_rv64ua_v_amoand_w, "rv64ua-v-amoand_w");
test_case!(#[ignore], test_suite_rv64ua_v_amomax_d, "rv64ua-v-amomax_d");
test_case!(#[ignore], test_suite_rv64ua_v_amomax_w, "rv64ua-v-amomax_w");
test_case!(#[ignore], test_suite_rv64ua_v_amomaxu_d, "rv64ua-v-amomaxu_d");
test_case!(#[ignore], test_suite_rv64ua_v_amomaxu_w, "rv64ua-v-amomaxu_w");
test_case!(#[ignore], test_suite_rv64ua_v_amomin_d, "rv64ua-v-amomin_d");
test_case!(#[ignore], test_suite_rv64ua_v_amomin_w, "rv64ua-v-amomin_w");
test_case!(#[ignore], test_suite_rv64ua_v_amominu_d, "rv64ua-v-amominu_d");
test_case!(#[ignore], test_suite_rv64ua_v_amominu_w, "rv64ua-v-amominu_w");
test_case!(#[ignore], test_suite_rv64ua_v_amoor_d, "rv64ua-v-amoor_d");
test_case!(#[ignore], test_suite_rv64ua_v_amoor_w, "rv64ua-v-amoor_w");
test_case!(#[ignore], test_suite_rv64ua_v_amoswap_d, "rv64ua-v-amoswap_d");
test_case!(#[ignore], test_suite_rv64ua_v_amoswap_w, "rv64ua-v-amoswap_w");
test_case!(#[ignore], test_suite_rv64ua_v_amoxor_d, "rv64ua-v-amoxor_d");
test_case!(#[ignore], test_suite_rv64ua_v_amoxor_w, "rv64ua-v-amoxor_w");
test_case!(#[ignore], test_suite_rv64ua_v_lrsc, "rv64ua-v-lrsc");

// RV64-UC
test_case!(test_suite_rv64uc_p_rvc, "rv64uc-p-rvc");

// This test requires setting up virtual memory, which requires supervisor-level privileges. Since
// switching to the Supervising PVM, these privileges are no longer accessible.
...
// These tests require setting up virtual memory, which requires supervisor-level privileges. Since
// switching to the Supervising PVM, these privileges are no longer accessible.
test_case!(#[ignore], test_suite_rv64ud_v_fadd, "rv64ud-v-fadd");
test_case!(#[ignore], test_suite_rv64ud_v_fclass, "rv64ud-v-fclass");
test_case!(#[ignore], test_suite_rv64ud_v_fcmp, "rv64ud-v-fcmp");
test_case!(#[ignore], test_suite_rv64ud_v_fcvt, "rv64ud-v-fcvt");
test_case!(#[ignore], test_suite_rv64ud_v_fcvt_w, "rv64ud-v-fcvt_w");
test_case!(#[ignore], test_suite_rv64ud_v_fdiv, "rv64ud-v-fdiv");
test_case!(#[ignore], test_suite_rv64ud_v_fmadd, "rv64ud-v-fmadd");
test_case!(#[ignore], test_suite_rv64ud_v_fmin, "rv64ud-v-fmin");
test_case!(#[ignore], test_suite_rv64ud_v_ldst, "rv64ud-v-ldst");
test_case!(#[ignore], test_suite_rv64ud_v_move, "rv64ud-v-move");
...
test_case!(#[ignore], test_suite_rv64uf_v_fclass, "rv64uf-v-fclass");
test_case!(#[ignore], test_suite_rv64uf_v_fcmp, "rv64uf-v-fcmp");
test_case!(#[ignore], test_suite_rv64uf_v_fcvt, "rv64uf-v-fcvt");
test_case!(#[ignore], test_suite_rv64uf_v_fcvt_w, "rv64uf-v-fcvt_w");
test_case!(#[ignore], test_suite_rv64uf_v_fdiv, "rv64uf-v-fdiv");
test_case!(#[ignore], test_suite_rv64uf_v_fmadd, "rv64uf-v-fmadd");
test_case!(#[ignore], test_suite_rv64uf_v_fmin, "rv64uf-v-fmin");
test_case!(#[ignore], test_suite_rv64uf_v_ldst, "rv64uf-v-ldst");
test_case!(#[ignore], test_suite_rv64uf_v_move, "rv64uf-v-move");
...
// These tests require setting up virtual memory, which requires supervisor-level privileges. Since
// switching to the Supervising PVM, these privileges are no longer accessible.
test_case!(#[ignore], test_suite_rv64ui_v_add, "rv64ui-v-add");
test_case!(#[ignore], test_suite_rv64ui_v_addi, "rv64ui-v-addi");
test_case!(#[ignore], test_suite_rv64ui_v_addiw, "rv64ui-v-addiw");
test_case!(#[ignore], test_suite_rv64ui_v_addw, "rv64ui-v-addw");
test_case!(#[ignore], test_suite_rv64ui_v_and, "rv64ui-v-and");
test_case!(#[ignore], test_suite_rv64ui_v_andi, "rv64ui-v-andi");
test_case!(#[ignore], test_suite_rv64ui_v_auipc, "rv64ui-v-auipc");
test_case!(#[ignore], test_suite_rv64ui_v_beq, "rv64ui-v-beq");
test_case!(#[ignore], test_suite_rv64ui_v_bge, "rv64ui-v-bge");
test_case!(#[ignore], test_suite_rv64ui_v_bgeu, "rv64ui-v-bgeu");
test_case!(#[ignore], test_suite_rv64ui_v_blt, "rv64ui-v-blt");
test_case!(#[ignore], test_suite_rv64ui_v_bltu, "rv64ui-v-bltu");
test_case!(#[ignore], test_suite_rv64ui_v_bne, "rv64ui-v-bne");
test_case!(#[ignore], test_suite_rv64ui_v_fence_i, "rv64ui-v-fence_i");
test_case!(#[ignore], test_suite_rv64ui_v_jal, "rv64ui-v-jal");
test_case!(#[ignore], test_suite_rv64ui_v_jalr, "rv64ui-v-jalr");
test_case!(#[ignore], test_suite_rv64ui_v_lb, "rv64ui-v-lb");
test_case!(#[ignore], test_suite_rv64ui_v_lbu, "rv64ui-v-lbu");
test_case!(#[ignore], test_suite_rv64ui_v_ld, "rv64ui-v-ld");
test_case!(#[ignore], test_suite_rv64ui_v_ld_st, "rv64ui-v-ld_st");
test_case!(#[ignore], test_suite_rv64ui_v_lh, "rv64ui-v-lh");
test_case!(#[ignore], test_suite_rv64ui_v_lhu, "rv64ui-v-lhu");
test_case!(#[ignore], test_suite_rv64ui_v_lui, "rv64ui-v-lui");
test_case!(#[ignore], test_suite_rv64ui_v_lw, "rv64ui-v-lw");
test_case!(#[ignore], test_suite_rv64ui_v_lwu, "rv64ui-v-lwu");
test_case!(#[ignore], test_suite_rv64ui_v_ma_data, "rv64ui-v-ma_data");
test_case!(#[ignore], test_suite_rv64ui_v_or, "rv64ui-v-or");
test_case!(#[ignore], test_suite_rv64ui_v_ori, "rv64ui-v-ori");
test_case!(#[ignore], test_suite_rv64ui_v_sb, "rv64ui-v-sb");
test_case!(#[ignore], test_suite_rv64ui_v_sd, "rv64ui-v-sd");
test_case!(#[ignore], test_suite_rv64ui_v_sh, "rv64ui-v-sh");
test_case!(#[ignore], test_suite_rv64ui_v_simple, "rv64ui-v-simple");
test_case!(#[ignore], test_suite_rv64ui_v_sll, "rv64ui-v-sll");
test_case!(#[ignore], test_suite_rv64ui_v_slli, "rv64ui-v-slli");
test_case!(#[ignore], test_suite_rv64ui_v_slliw, "rv64ui-v-slliw");
test_case!(#[ignore], test_suite_rv64ui_v_sllw, "rv64ui-v-sllw");
test_case!(#[ignore], test_suite_rv64ui_v_slt, "rv64ui-v-slt");
test_case!(#[ignore], test_suite_rv64ui_v_slti, "rv64ui-v-slti");
test_case!(#[ignore], test_suite_rv64ui_v_sltiu, "rv64ui-v-sltiu");
test_case!(#[ignore], test_suite_rv64ui_v_sltu, "rv64ui-v-sltu");
test_case!(#[ignore], test_suite_rv64ui_v_sra, "rv64ui-v-sra");
test_case!(#[ignore], test_suite_rv64ui_v_srai, "rv64ui-v-srai");
test_case!(#[ignore], test_suite_rv64ui_v_sraiw, "rv64ui-v-sraiw");
test_case!(#[ignore], test_suite_rv64ui_v_sraw, "rv64ui-v-sraw");
test_case!(#[ignore], test_suite_rv64ui_v_srl, "rv64ui-v-srl");
test_case!(#[ignore], test_suite_rv64ui_v_srli, "rv64ui-v-srli");
test_case!(#[ignore], test_suite_rv64ui_v_srliw, "rv64ui-v-srliw");
test_case!(#[ignore], test_suite_rv64ui_v_srlw, "rv64ui-v-srlw");
test_case!(#[ignore], test_suite_rv64ui_v_st_ld, "rv64ui-v-st_ld");
test_case!(#[ignore], test_suite_rv64ui_v_sub, "rv64ui-v-sub");
test_case!(#[ignore], test_suite_rv64ui_v_subw, "rv64ui-v-subw");
test_case!(#[ignore], test_suite_rv64ui_v_sw, "rv64ui-v-sw");
test_case!(#[ignore], test_suite_rv64ui_v_xor, "rv64ui-v-xor");
test_case!(#[ignore], test_suite_rv64ui_v_xori, "rv64ui-v-xori");
...
// These tests require setting up virtual memory, which requires supervisor-level privileges. Since
// switching to the Supervising PVM, these privileges are no longer accessible.
test_case!(#[ignore], test_suite_rv64um_v_div, "rv64um-v-div");
test_case!(#[ignore], test_suite_rv64um_v_divu, "rv64um-v-divu");
test_case!(#[ignore], test_suite_rv64um_v_divuw, "rv64um-v-divuw");
test_case!(#[ignore], test_suite_rv64um_v_divw, "rv64um-v-divw");
test_case!(#[ignore], test_suite_rv64um_v_mul, "rv64um-v-mul");
test_case!(#[ignore], test_suite_rv64um_v_mulh, "rv64um-v-mulh");
test_case!(#[ignore], test_suite_rv64um_v_mulhsu, "rv64um-v-mulhsu");
test_case!(#[ignore], test_suite_rv64um_v_mulhu, "rv64um-v-mulhu");
test_case!(#[ignore], test_suite_rv64um_v_mulw, "rv64um-v-mulw");
test_case!(#[ignore], test_suite_rv64um_v_rem, "rv64um-v-rem");
test_case!(#[ignore], test_suite_rv64um_v_remu, "rv64um-v-remu");
test_case!(#[ignore], test_suite_rv64um_v_remuw, "rv64um-v-remuw");
test_case!(#[ignore], test_suite_rv64um_v_remw, "rv64um-v-remw");
