...
pub fn opcode_to_argsshape(opcode: &OpCode) -> ArgsShape {
    ...
    match opcode {
        ...
        | CLwsp | CSw | CSwsp | CJ | CBeqz | CBnez | CLi | CLui | CAddi16sp | CAddi4spn | CSlli
        | CSrli | CSrai | CAndi | CAnd | COr | CXor | CSub | CAddw | CSubw | CNop | CLd | CLdsp
        | CSd | CSdsp | Unknown | UnknownCompressed => ArgsShape::XSrcXDest,
        ...
        CMv | CAdd | CJr | CJalr | CAddi | CAddiw => ArgsShape::NZXSrcNZXDest,
    }
}
