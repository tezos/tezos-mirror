...
external octez_riscv_storage_commit: repo -> mut_state -> id = "octez_riscv_storage_commit"
external octez_riscv_storage_checkout: repo -> id -> mut_state option = "octez_riscv_storage_checkout"
...
external octez_riscv_mut_get_outbox_for_level: mut_state -> int32 -> output list = "octez_riscv_mut_get_outbox_for_level"
...
external octez_riscv_test_output_list: output list -> output list = "octez_riscv_test_output_list"
