...
fn shared_object_dir() -> PathBuf {
    ...
    // XXX: The following section is disabled because it does not work correctly
    //      when specifying a different `--target-dir` during compilation.
    //      Fortunately we don't have to make use of this feature.
    //
