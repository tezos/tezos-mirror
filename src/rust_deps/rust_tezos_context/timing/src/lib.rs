...
const PROTO_HASH_JAKARTA: &str = "PtJakart2xVj7pYXJBXrqHgd82rdkLey5ZeeGwDgPp9rhQUbSqY";
...
const PROTOCOLS: &[(&str, Protocol)] = &[
    ...
    (PROTO_HASH_JAKARTA, Protocol::Jakarta),
];
