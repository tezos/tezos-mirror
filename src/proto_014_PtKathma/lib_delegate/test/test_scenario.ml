...
let bootstrap2 = Tezos_crypto.Signature.V0.Public_key.hash bootstrap2

let bootstrap3 = Tezos_crypto.Signature.V0.Public_key.hash bootstrap3

let bootstrap4 = Tezos_crypto.Signature.V0.Public_key.hash bootstrap4

let bootstrap5 = Tezos_crypto.Signature.V0.Public_key.hash bootstrap5
