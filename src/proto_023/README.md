...
There are other protocol-related files outside of this directory. Integration tests are located in `tezt/`. Protocol documentation is located in `docs/seoul/` and the protocol changelog is in `docs/protocols/seoul.rst`.
...
<https://tezos.gitlab.io/developer/entering_seoul.html>
...
https://tezos.gitlab.io/api/odoc/_html/tezos-protocol-seoul
