...
**Do NOT rely on injector feedback to determine operation outcomes.** The injector tells you an operation was injected/included, but this can be stale after reorgs. Instead, observe L1 blocks directly during normal daemon processing. See also `lib_smart_rollup_node/AGENTS.md`.
