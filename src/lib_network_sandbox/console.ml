  ...
  let date =
    if o#console.with_timestamp then
      let date =
        ...
        |> Tezos_base.Time.System.to_notation
      in
      sprintf "[%s]" date
    else ""
  in
