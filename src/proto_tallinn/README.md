...
There are other protocol-related files outside of this directory. Integration tests are located in `tezt/`. Protocol documentation is located in `docs/tallinn/` and the protocol changelog is in `docs/protocols/tallinn.rst`.
...
<https://tezos.gitlab.io/developer/entering_tallinn.html>
...
https://tezos.gitlab.io/api/odoc/_html/tezos-protocol-tallinn
