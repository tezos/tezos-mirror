...
class TestAllPerBlockVotes:
    ...
    def test_path_overrides_default_location(self, sandbox: Sandbox):
        ...
        run_vote_file_with_path(
            sandbox, "tests_013/per_block_vote_files/off.json"
        )
    ...
    def test_true_vote_file(self, sandbox: Sandbox):
        filename = "tests_013/per_block_vote_files/true.json"
        run_wrong_content_file_test(sandbox, filename, 'pass')

    def test_false_vote_file(self, sandbox: Sandbox):
        filename = "tests_013/per_block_vote_files/false.json"
        run_wrong_content_file_test(sandbox, filename, 'pass')

    def test_wrong_key(self, sandbox: Sandbox):
        filename = "tests_013/per_block_vote_files/wrong_key.json"
        run_wrong_content_file_test(sandbox, filename, 'pass')
