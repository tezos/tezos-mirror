...
tokens implemented using tickets."""
        ...
        builder_path = path.join(MINI_SCENARIOS_CONTRACT_PATH,
                                 'ticket_builder_fungible.tz')

        wallet_path = path.join(MINI_SCENARIOS_CONTRACT_PATH,
        ...
        def originate_wallet(name):
            ...
            origination = client.originate(
                ...
                args=['--init', f'Pair "{manager_address}" {{}}',
                      '--burn-cap', "10"])
