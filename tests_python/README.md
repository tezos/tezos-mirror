...
class TestExample:
    ...
    def test_wait_sync_proto(self, sandbox):
        ...
        for client in clients:
            proto = "Pt24m4xiPbLDhVgVfABUjirbmda3yohdN82Sp9FeuAXJ4eV9otd"
...
On `master`, protocol alpha is named `Pt24m4xiPbLDhVgVfABUjirbmda3yohdN82Sp9FeuAXJ4eV9otd`, and deamons binary
