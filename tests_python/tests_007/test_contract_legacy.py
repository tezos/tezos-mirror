...
class TestContractLegacy:
    ...
    @pytest.mark.parametrize(
        ...
        [  # FORMAT: assert_output contract_file storage input expected_result
            (
                'create_contract.tz',
                'Unit',
                'Left "tz1ddb9NMYHZi5UzPdzTZMYQQZoMub195zgv"',
                'Unit',
            ),
            (
    ...
    def test_contract_input_output(
        self, client_regtest, contract, param, storage, expected
    ):
        client = client_regtest
    ...
    def test_create_contract_flags(
        ...
        contract = path.join(LEGACY_CONTRACT_PATH, 'create_contract_flags.tz')

        arg = (
            '(Pair "tz1ddb9NMYHZi5UzPdzTZMYQQZoMub195zgv"'
