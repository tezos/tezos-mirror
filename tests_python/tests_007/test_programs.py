  ...
  { "prim": "code",
    "args":
      [ [ { "prim": "CDR" },
          ...
          { "prim": "CONS" }, { "prim": "PAIR" } ] ] } ]""",
    "binary":
    "0x02000000300500036c0501036c050202000000210317053d036d03490743036a0000034f034d0321051f0200000002031b031b0342",  # pylint: disable=line-too-long # noqa: E501
    "ocaml":
    "Seq (0, [Prim (1, K_parameter, [Prim (2, T_unit, [], [])], []); Prim (3, K_storage, [Prim (4, T_unit, [], [])], []); Prim (5, K_code, [Seq (6, [Prim (7, I_CDR, [], []); Prim (8, I_NIL, [Prim (9, T_operation, [], [])], []); Prim (10, I_SELF, [], []); Prim (11, I_PUSH, [Prim (12, T_mutez, [], []); Int (13, Z.zero)], []); Prim (14, I_UNIT, [], []); Prim (15, I_TRANSFER_TOKENS, [], []); Prim (16, I_DUP, [], []); Prim (17, I_DIP, [Seq (18, [Prim (19, I_CONS, [], [])])], []); Prim (20, I_CONS, [], []); Prim (21, I_PAIR, [], [])])], [])])"  # pylint: disable=line-too-long # noqa: E501
}
CONVERT_DATA = {
    "michelson": """{ DROP ;
...
class TestProgramsCommands:
    def test_convert_script(self, client: Client):
        for (input_, output) in itertools.product(
            ...
            result = client.run([
                "convert", "script", CONVERT_SCRIPT[input_], "from", input_,
                "to", output
            ])
    ...
    def test_convert_data(self, client: Client):
        for (input_, output, typecheck) in itertools.product(
                ...
                [True, False]):
            args = [
                "convert", "data", CONVERT_DATA[input_], "from", input_, "to",
                output
            ]
            if typecheck:
