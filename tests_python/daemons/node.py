...
class Node:
    ...
    def init_config(self):
        ...
        subprocess.run(node_config, check=True, capture_output=True, text=True)
    ...
    def init_id(self):
        ...
        subprocess.run(node_identity, check=True, capture_output=True,
                       text=True)
        if self.use_tls:
    ...
    def upgrade_storage(self):
        ...
        subprocess.run(node_upgrade, check=True, capture_output=True,
                       text=True)
    ...
    def snapshot_export(self, file, params=None):
        ...
        subprocess.run(snapshot_cmd, check=True, capture_output=True,
                       text=True)
