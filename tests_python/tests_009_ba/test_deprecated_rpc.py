...
# This test check that the deprecated RPC in protocol florence works
# as in delphi. This test can be removed as the activation of the
# protocol 008 that contains the deprecated RPC occured. To do that it
# runs the same test twice, first with delphi activated then with
# florence activated.
...
PROTO_B_PARAMETERS = constants.FLOR_BA_PARAMETERS
