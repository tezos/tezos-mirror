#################################################################################
# This is a raw copy of the dal.Dockerfile. Mind updating it the dal.Dockerfile
# changes.
#################################################################################
...
#################################################################################
# Lines below are added to the original dal.Dockerfile file that is copy/paste
# above. Mind keeping the above dal.Dockerfile copy synchronised with the
