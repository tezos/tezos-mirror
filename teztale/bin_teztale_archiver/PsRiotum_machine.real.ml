...
module Block_services =
  Tezos_client_022_PsRiotum.Protocol_client_context.Alpha_block_services
...
module Services : Protocol_machinery.PROTOCOL_SERVICES = struct
  ...
  type wrap_full = Tezos_client_022_PsRiotum.Protocol_client_context.wrap_full

  let wrap_full cctxt =
    new Tezos_client_022_PsRiotum.Protocol_client_context.wrap_full cctxt
