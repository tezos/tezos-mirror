...
- fixed protocol constants are defined in the module
  ...
  <tezos-protocol-tallinn/Tezos_raw_protocol_tallinn/Constants_repr/index.html>`
- parametric constants are defined in the module
  :package-api:`Constants_parametric_repr
  <tezos-protocol-tallinn/Tezos_raw_protocol_tallinn/Constants_parametric_repr/index.html>`

- derived constants are defined in the module
  :package-api:`Constants_repr.Derived
  <tezos-protocol-tallinn/Tezos_raw_protocol_tallinn/Constants_repr/Derived/index.html>`
