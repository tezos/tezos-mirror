...
and :ref:`consensus operations <consensus_operations_tallinn>`. The aggregatable property of BLS signatures is used with
...
address can provide data and optionally some tokens, and triggers the execution of the code, which may read and update the storage. The transaction can succeed or fail, according to the :ref:`transaction semantics <transaction_semantics_tallinn>`.
