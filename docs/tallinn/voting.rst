...
- *Proposal period*: During this period, delegates can
  ...
  measured in the :ref:`voting power <voting_power_t024>` that delegates supporting the
...
is the sum of its :ref:`total_staked<total_staked_t024>` and
:ref:`total_delegated<total_delegated_t024>` amounts, measured in
