...
- *Proposal period*: During this period, delegates can
  ...
  measured in the :ref:`voting power <voting_power_tallinn>` that delegates supporting the
...
is the sum of its :ref:`total_staked<total_staked_tallinn>` and
:ref:`total_delegated<total_delegated_tallinn>` amounts, measured in
...
:src:`src/proto_024_PtTALLiN/lib_protocol/amendment.ml`.
...
:src:`src/proto_024_PtTALLiN/lib_protocol/operation_repr.ml`.
