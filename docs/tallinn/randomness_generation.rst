...
by the adaptive issuance coefficient <adaptive_issuance_t024>`
...
<adaptive_issuance_t024>` and weighted by constant ``SEED_NONCE_REVELATION_TIP_WEIGHT``,
