...
<https://gitlab.com/tzip/tzip/-/blob/master/proposals/tzip-7/tzip-7.md>`_.
...
<https://gitlab.com/tzip/tzip/-/blob/master/proposals/tzip-7/ManagedLedger.tz>`_.
...
<https://gitlab.com/tzip/tzip/-/blob/master/proposals/tzip-4/tzip-4.md#view-entrypoints>`_
...
can be replaced with e.g. ``alpha`` or ``009-PsFLoren``).
