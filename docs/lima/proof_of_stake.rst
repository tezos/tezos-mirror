...
The PRNG's :ref:`seeds <random_seed_lima>` are obtained from random
...
:ref:`protocol constant <protocol_constants_lima>`.
...
snapshot<snapshots_lima>` for the cycle to which the level belongs.
