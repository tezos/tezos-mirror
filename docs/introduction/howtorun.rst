...
Assuming you run on Delphinet, to know if you baked, just run::

    ./delphinet.sh baker log
    ./delphinet.sh endorser log

(replace ``delphinet.sh`` with ``mainnet.sh`` for Mainnet).
