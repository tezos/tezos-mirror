...
Three economic protocols are included in the main Tezos repository.
  ...
  - :package:`tezos-protocol-005-PsBabyM1`
    (:package:`tezos-embedded-protocol-005-PsBabyM1`) is the first real
...
compatible, and library vs command line interface.
  ...
  - :package:`tezos-client-base` define the client context, which is
    ...
    :package:`tezos-protocol-005-PsBabyM1`, are abstracted over this object
    type. That way, it is possible to use the same code for different
    platforms or toolkits.
  - :package:`tezos-client-005-PsBabyM1` provides some functions to perform
  ...
  - :package:`tezos-client-005-PsBabyM1-commands` plugs the functions from
    :package:`tezos-client-005-PsBabyM1` as handlers for the alpha specific
    commands of the ``tezos-client`` command line wallet.
...
run them.
 ...
 - :package-name:`tezos-protocol-005-PsBabyM1`
   (in directory :src:`src/proto_005_PsBabyM1/lib_protocol/test/`):
...
~~~~~~~~~~~~~~~~~~~~~
  ...
  - :package:`tezos-baker-005-PsBabyM1` provides the ``tezos-baker-005-PsBabyM1``
    binary.
  - :package:`tezos-endorser-005-PsBabyM1` provides the ``tezos-endorser-005-PsBabyM1``
    binary.
  - :package:`tezos-accuser-005-PsBabyM1` provides the ``tezos-accuser-005-PsBabyM1``
    binary.
