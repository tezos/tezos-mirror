...
- Its state is given by the :ref:`context<def_context_ushuaia>`, the internal
...
modes<validation_modes_ushuaia>`. For example, these modes enable the
...
.. _protocol_classification_ushuaia:
...
.. _block_validation_overview_ushuaia:
...
candidate block declares consistent :ref:`level<def_level_ushuaia>`,
:ref:`round<def_round_ushuaia>`, and timestamp values; that it carries a valid
...
:ref:`operation_validity_ushuaia` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_ushuaia>`. That is,
...
block (see :ref:`partial_application_ushuaia` above). This feature
...
.. _manager_operations_validity_ushuaia:
...
:ref:`Manager operations<manager_operations_ushuaia>` are a class of
...
A :ref:`batch<manager_operations_batches_ushuaia>` of manager operations
...
.. _manager_operations_application_ushuaia:
