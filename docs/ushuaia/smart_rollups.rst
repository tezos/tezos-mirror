...
.. _reveal_data_channel_smart_rollups_ushuaia:
...
committers (see :ref:`private_rollups_ushuaia`).
...
deposit of 10,000 tez, called :ref:`**frozen bonds**<bonds_ushuaia>`. For this reason, the
