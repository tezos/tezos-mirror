...
.. _randomness_generation_ushuaia:
...
by the adaptive issuance coefficient <adaptive_issuance_ushuaia>`
...
<adaptive_issuance_ushuaia>` and weighted by constant ``SEED_NONCE_REVELATION_TIP_WEIGHT``,
is given for the first correct VDF revelation,
subsequent VDF revelation operations being discarded.

.. _rg_constants:
.. _rg_constants_ushuaia:
