...
- *Proposal period*: During this period, delegates can
  ...
  measured in the :ref:`voting power <voting_power_ushuaia>` that delegates supporting the
...
is the sum of its :ref:`total_staked<total_staked_ushuaia>` and
:ref:`total_delegated<total_delegated_ushuaia>` amounts, measured in
...
:src:`src/proto_025_PsUshuai/lib_protocol/amendment.ml`.
...
:src:`src/proto_025_PsUshuai/lib_protocol/operation_repr.ml`.
