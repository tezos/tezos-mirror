...
with :ref:`tz4 address accounts <tz4_accounts_ushuaia>`,
...
commands <native_multisig_rpc_cli_ushuaia>` to facilitate the signing of
...
.. _native_multisig_rpc_cli_ushuaia:
