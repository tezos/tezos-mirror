...
``src/proto_009_PsFLorBA/lib_protocol/amendment.ml``.
...
``src/proto_009_PsFLorBA/lib_protocol/operation_repr.ml``.
...
:ref:`client_manual_009_BA`.

For vote related RPCs check the :ref:`rpc_index_009_BA` under the prefix
``vote/``.
