...
_`Double signing`
    ...
    part of the double signer's deposit -- see :ref:`Slashing<slashing_oxford>`.
...
_`Fee`
    ...
    Currently, only :ref:`manager operations<manager_operations_oxford>`
...
_`Stake`
    ...
    :ref:`here<active_stake_oxford>` for details.
...
_`Validation pass`
    ...
    application<operation_validity_oxford>` of certain classes of
    operations.
