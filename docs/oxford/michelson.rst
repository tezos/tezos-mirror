...
the :ref:`concrete syntax <ConcreteSyntax_oxford>`. In particular
...
:ref:`special annotations <SpecialAnnotations_oxford>` and are not allowed everywhere.
...
The multisig commands of :ref:`Octez command line client <client_manual_oxford>`
use this
