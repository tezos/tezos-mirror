...
of a smart rollup node. More details can be found in :ref:`sending_external_inbox_message_oxford`.
...
#. **preimage requests**: The rollup can request arbitrary data of at
   ...
   :ref:`populating_the_reveal_channel_oxford`.
...
operation (see :ref:`triggering_execution_outbox_message_oxford`), typically
...
.. _sending_external_inbox_message_oxford:
...
.. _sending_internal_inbox_message_oxford:
...
.. _populating_the_reveal_channel_oxford:
