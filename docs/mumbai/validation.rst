...
- Its state is given by the :ref:`context<def_context_mumbai>`, the internal
...
candidate block declares consistent :ref:`level<def_level_mumbai>`,
:ref:`round<def_round_mumbai>`, and timestamp values; that it carries a valid
