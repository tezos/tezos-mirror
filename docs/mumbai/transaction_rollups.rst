...
alphabet (see also the :ref:`kinds of address prefixes in Tezos <address_prefixes_mumbai>`).
...
In order to ensure that layer-2 transfers and :ref:`ticket withdrawals<withdrawals_mumbai>` are
...
any :ref:`ticket withdrawals<withdrawals_mumbai>` generated by the message.
...
#. Committed: During this stage, commitments can be :ref:`rejected<rejected_mumbai>`, moving
   ...
   :ref:`rejected<rejected_mumbai>`.  The "finalize" operation removes the inbox from the
   context.

#. Finalized: During this stage, any :ref:`dispatch tickets<withdrawals_mumbai>`
