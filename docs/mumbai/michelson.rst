...
the :ref:`concrete syntax <ConcreteSyntax_mumbai>`. In particular
...
-  ``big_map (k) (t)``: Lazily deserialized maps from keys of type
   ...
   See the section on :ref:`operations on big maps <OperationsOnBigMaps_mumbai>` for a description of the syntax of values of type ``big_map (k) (t)`` and available operations.
...
:ref:`special annotations <SpecialAnnotations_mumbai>` and are not allowed everywhere.
...
The multisig commands of :ref:`Octez command line client <client_manual_mumbai>`
use this
