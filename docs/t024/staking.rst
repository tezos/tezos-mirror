...
complementary to the existing :ref:`delegate <def_delegate_t024>`
...
subject to :ref:`slashing <slashing_t024>` if
the delegate misbehaves by :ref:`double-signing <def_double_signing_t024>`
...
:ref:`Participation rewards <adaptive_rewards_t024>` are automatically shared
...
policy <staking_policy_configuration_t024>` by setting staking parameters
...
management <staked_funds_management_t024>`).

.. _pseudo_operations_t024:
...
the same name introduced for :ref:`user accounts <def_user_account_t024>`.
...
.. _staking_policy_configuration_t024:
...
another :ref:`UNSTAKE_FINALIZATION_DELAY<cs_constants_t024>` full
