...
- Its state is given by the :ref:`context<def_context_next>`, the internal
...
modes<validation_modes_next>`. For example, these modes enable the
...
:package-api:`Main<tezos-protocol-next/Tezos_raw_protocol_next/Main/index.html>`
module.
...
.. _block_validation_overview_next:
...
candidate block declares consistent :ref:`level<def_level_next>`,
:ref:`round<def_round_next>`, and timestamp values; that it carries a valid
...
:ref:`operation_validity_next` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_next>`. That is,
...
block (see :ref:`partial_application_next` above). This feature
...
.. _manager_operations_validity_next:
...
:ref:`Manager operations<manager_operations_next>` are a class of
...
A :ref:`batch<manager_operations_batches_next>` of manager operations
...
.. _manager_operations_application_next:
