...
- Its state is given by the :ref:`context<def_context_r022>`, the internal
...
modes<validation_modes_r022>`. For example, these modes enable the
...
.. _block_validation_overview_r022:
...
candidate block declares consistent :ref:`level<def_level_r022>`,
:ref:`round<def_round_r022>`, and timestamp values; that it carries a valid
...
:ref:`operation_validity_r022` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_r022>`. That is,
...
block (see :ref:`partial_application_r022` above). This feature
...
.. _manager_operations_validity_r022:
...
:ref:`Manager operations<manager_operations_r022>` are a class of
...
A :ref:`batch<manager_operations_batches_r022>` of manager operations
...
.. _manager_operations_application_r022:
