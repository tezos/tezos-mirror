...
.. note::
  ...
  rate<minimum_and_maximum_rates_beta>` is reached, it is possible,
...
<minimum_and_maximum_rates_beta>`, along with the :ref:`adaptive
maximum <adaptive_maximum_beta>`, computed for the cycle ``c + 1``.
