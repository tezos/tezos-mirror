...
A *delegate* is any :ref:`user account <def_user_account_quebeca>` registered as
...
Any :ref:`account <def_account_quebeca>` (user account or smart contract) can specify a delegate
...
<protocol_constants_quebeca>`. A delegate cannot stop self-delegating.
...
:ref:`minimal balance requirements<minimal_baking_power_quebeca>`.
...
If the :ref:`adaptive issuance <adaptive_issuance_quebeca>`
...
The adaptive issuance feature :ref:`documentation <adaptive_issuance_quebeca>`.
