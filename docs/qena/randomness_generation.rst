...
.. _randomness_generation_quebeca:
...
by the adaptive issuance coefficient <adaptive_issuance_quebeca>`, is given for
...
<adaptive_issuance_quebeca>`, is given for the first correct VDF revelation,
subsequent VDF revelation operations being discarded.

.. _rg_constants_quebeca:
