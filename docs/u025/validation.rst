...
- Its state is given by the :ref:`context<def_context_u025>`, the internal
...
modes<validation_modes_u025>`. For example, these modes enable the
...
.. _block_validation_overview_u025:
...
candidate block declares consistent :ref:`level<def_level_u025>`,
:ref:`round<def_round_u025>`, and timestamp values; that it carries a valid
...
:ref:`operation_validity_u025` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_u025>`. That is,
...
block (see :ref:`partial_application_u025` above). This feature
...
.. _manager_operations_validity_u025:
...
:ref:`Manager operations<manager_operations_u025>` are a class of
...
A :ref:`batch<manager_operations_batches_u025>` of manager operations
...
.. _manager_operations_application_u025:
