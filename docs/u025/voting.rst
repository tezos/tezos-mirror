...
- *Proposal period*: During this period, delegates can
  ...
  measured in the :ref:`voting power <voting_power_u025>` that delegates supporting the
...
is the sum of its :ref:`total_staked<total_staked_u025>` and
:ref:`total_delegated<total_delegated_u025>` amounts, measured in
...
:src:`src/proto_025_PsGXQmSv/lib_protocol/amendment.ml`.
...
:src:`src/proto_025_PsGXQmSv/lib_protocol/operation_repr.ml`.
