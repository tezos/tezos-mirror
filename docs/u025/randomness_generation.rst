...
by the adaptive issuance coefficient <adaptive_issuance_u025>`
...
<adaptive_issuance_u025>` and weighted by constant ``SEED_NONCE_REVELATION_TIP_WEIGHT``,
