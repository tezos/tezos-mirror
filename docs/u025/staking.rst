...
complementary to the existing :ref:`delegate <def_delegate_u025>`
...
subject to :ref:`slashing <slashing_u025>` if
the delegate misbehaves by :ref:`double-signing <def_double_signing_u025>`
...
:ref:`Participation rewards <adaptive_rewards_u025>` are automatically shared
...
policy <staking_policy_configuration_u025>` by setting staking parameters
...
management <staked_funds_management_u025>`).

.. _pseudo_operations_u025:
...
the same name introduced for :ref:`user accounts <def_user_account_u025>`.
...
.. _staking_policy_configuration_u025:
...
another :ref:`UNSTAKE_FINALIZATION_DELAY<cs_constants_u025>` full
