...
The :ref:`randomness<random_seed_jakarta>` is obtained from information already found on the
...
during cycle ``n-1`` under penalty of forfeiting all of its expected
...
The seed of the PRNG is the :ref:`random seed <random_seed_jakarta>` associated with cycle ``n-PRESERVED_CYCLES``.
