...
the :ref:`concrete syntax <ConcreteSyntax_kathmandu>`. In particular
...
.. _michelson_type_system_kathmandu:
...
-  ``big_map (k) (t)``: Lazily deserialized maps from keys of type
   ...
   See the section on :ref:`operations on big maps <OperationsOnBigMaps_kathmandu>` for a description of the syntax of values of type ``big_map (k) (t)`` and available operations.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
.. _OperationsOnBigMaps_kathmandu:
...
.. _MichelsonSetDelegate_kathmandu:
...
:ref:`special annotations <SpecialAnnotations_kathmandu>` and are not allowed everywhere.
...
The multisig commands of :ref:`Tezos command line client <client_manual_kathmandu>`
use this
