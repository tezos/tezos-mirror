...
:ref:`blocks<block_validation_overview_kathmandu>` and their
:ref:`operations<operation_validity_kathmandu>`.
...
- The shell changes the head of the chain to this new block only if
  ...
  :ref:`valid<block_validation_overview_kathmandu>` only if all the
  operations included are also
  :ref:`valid<operation_validity_kathmandu>`.

The support provided by the protocol for validating blocks can be
modulated by different :ref:`validation
modes<validation_modes_kathmandu>`. They allow using this same
interface for quite different use cases, as follows:

- being able to :ref:`apply<full_application_kathmandu>` a block,
  typically used by the shell's :doc:`validator <../shell/validation>`
  component;
- being able to :ref:`construct<full_construction_kathmandu>` a block,
  typically used by the baker daemon to *bake* -- that is, to produce
  -- a new block;
- being able to :ref:`partially construct<partial_construction_kathmandu>`
  a block, typically used by the :doc:`prevalidator
  <../shell/prevalidation>` to determine valid operations in the
  mempool; and,
- being able to :ref:`pre-apply<partial_application_kathmandu>` a
...
- fixed protocol constants are defined in the module
  ...
  <tezos-protocol-014-PtKathma/Tezos_raw_protocol_014_PtKathma/Constants_repr/index.html>`
- parametric constants are defined in the module
  :package-api:`Constants_parametric_repr
  <tezos-protocol-014-PtKathma/Tezos_raw_protocol_014_PtKathma/Constants_parametric_repr/index.html>`
...
- :ref:`proof-of-stake parameters <ps_constants_kathmandu>`.
- :ref:`consensus-related parameters <cs_constants_kathmandu>`
- :ref:`randomness generation parameters <rg_constants_kathmandu>`.
