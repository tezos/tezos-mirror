...
complementary to the existing :ref:`delegate <def_delegate_s023>`
...
subject to :ref:`slashing <slashing_s023>` if
the delegate misbehaves by :ref:`double-signing <def_double_signing_s023>`
...
:ref:`Participation rewards <adaptive_rewards_s023>` are automatically shared
...
policy <staking_policy_configuration_s023>` by setting staking parameters
...
management <staked_funds_management_s023>`).

.. _pseudo_operations_s023:
...
the same name introduced for :ref:`user accounts <def_user_account_s023>`.
...
.. _staking_policy_configuration_s023:
...
another :ref:`UNSTAKE_FINALIZATION_DELAY<cs_constants_s023>` full
