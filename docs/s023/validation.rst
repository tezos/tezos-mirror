...
- Its state is given by the :ref:`context<def_context_s023>`, the internal
...
modes<validation_modes_s023>`. For example, these modes enable the
...
<octez-proto-libs/Tezos_protocol_environment/V15/module-type-T/Updater/module-type-PROTOCOL/index.html>`
module in the :doc:`protocol
environment<../shell/protocol_environment>` ``V15``, and it is
implemented by this protocol in the
:package-api:`Main<tezos-protocol-023-PtSEouLo/Tezos_raw_protocol_023_PtSEouLo/Main/index.html>`
module.
...
.. _block_validation_overview_s023:
...
candidate block declares consistent :ref:`level<def_level_s023>`,
:ref:`round<def_round_s023>`, and timestamp values; that it carries a valid
...
:ref:`operation_validity_s023` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_s023>`. That is,
...
block (see :ref:`partial_application_s023` above). This feature
...
.. _manager_operations_validity_s023:
...
:ref:`Manager operations<manager_operations_s023>` are a class of
...
A :ref:`batch<manager_operations_batches_s023>` of manager operations
...
.. _manager_operations_application_s023:
