...
- *Proposal period*: During this period, delegates can
  ...
  measured in the :ref:`voting power <voting_power_next>` that delegates supporting the
...
is the sum of its :ref:`total_staked<total_staked_next>` and
:ref:`total_delegated<total_delegated_next>` amounts, measured in
...
:src:`src/proto_next/lib_protocol/amendment.ml`.
...
:src:`src/proto_next/lib_protocol/operation_repr.ml`.
