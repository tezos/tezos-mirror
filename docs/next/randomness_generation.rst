...
by the adaptive issuance coefficient <adaptive_issuance_next>`, is given for
...
<adaptive_issuance_next>`, is given for the first correct VDF revelation,
