...
A fixed percentage, defined by a protocol parameter called ``DAL_REWARDS_RATIO``, set to %10, of the total :ref:`participation rewards<adaptive_rewards_rio>` is allocated to the DAL.
