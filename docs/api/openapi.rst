...
- `rpc-openapi.json (version 15.0) <https://gitlab.com/tezos/tezos/-/blob/master/docs/api/rpc-openapi.json>`_

- `rpc-openapi-rc.json (version 16.0~rc1) <https://gitlab.com/tezos/tezos/-/blob/master/docs/api/rpc-openapi-rc.json>`_
...
- `mumbai-openapi.json (version 16.0~rc1) <https://gitlab.com/tezos/tezos/-/blob/master/docs/api/mumbai-openapi.json>`_

The OpenAPI specification for RPCs which are related to the mempool
and specific to the Lima protocol can be found at:

- `mumbai-mempool-openapi.json (version 16.0~rc1) <https://gitlab.com/tezos/tezos/-/blob/master/docs/api/mumbai-mempool-openapi.json>`_
