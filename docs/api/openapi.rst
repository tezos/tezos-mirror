...
- :src:`docs/api/rpc-openapi-rc.json` (version 22.0~rc2)
...
- :src:`docs/api/quebec-openapi-rc.json` (version 22.0~rc2)
...
- :src:`docs/api/quebec-mempool-openapi-rc.json` (version 22.0~rc2)
...
- :src:`docs/api/rio-openapi.json` (version 22.0~rc2)

The OpenAPI specifications for RPCs which are related to the mempool
and specific to the Rio protocol proposal can be found at:

- :src:`docs/api/rio-mempool-openapi.json` (version 22.0~rc2)
...
- :src:`docs/api/quebec-smart-rollup-node-openapi-rc.json` (version 22.0~rc2)
...
- :src:`docs/api/dal-node-openapi-rc.json` (version 22.0~rc2)
