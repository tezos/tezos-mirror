...
:src:`src/proto_010_PtGRANAD/lib_protocol/amendment.ml`.
...
:src:`src/proto_010_PtGRANAD/lib_protocol/operation_repr.ml`.
...
:ref:`client_manual_010`.

For vote related RPCs check the :ref:`rpc_index_010` under the prefix
``votes/``.
