...
The :ref:`randomness<random_seed_010>` is obtained from information already found on the
...
:ref:`protocol constant <protocol_constants_010>`.
...
The seed of the PRNG is the :ref:`random seed <random_seed_010>` associated with cycle ``n-PRESERVED_CYCLES``.
