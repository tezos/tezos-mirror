...
the :ref:`concrete syntax <ConcreteSyntax_010>`. In particular
...
-  ``big_map (k) (t)``: Lazily deserialized maps from keys of type
   ...
   section on :ref:`operations on big maps <OperationsOnBigMaps_010>`
...
:ref:`special annotations <SpecialAnnotations_010>` and are not allowed everywhere.
...
The multisig commands of :ref:`Tezos command line client <client_manual_010>`
use this
