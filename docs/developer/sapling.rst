...
(see the :ref:`Michelson reference<michelson>`
for more details).
...
::
   ...
   tezos-client sapling use key alice for contract shielded-tez
   tezos-client sapling gen key bob
   tezos-client sapling use key bob for contract shielded-tez
   ...
   tezos-client bake for bootstrap1
   tezos-client sapling get balance for alice --for-contract shielded-tez
   ...
   tezos-client bake for bootstrap1
   tezos-client sapling get balance for bob --for-contract shielded-tez
