...
Octez uses Python to build this documentation website (:doc:`https://octez.tezos.com/docs/ <../index>`) and for a limited set of
...
- ``python 3.12.3``. It is recommended to use `pyenv
...
- `poetry 1.8.3 <https://python-poetry.org/>`_ to manage the python dependencies and
...
Now we can use ``pyenv`` to install Python 3.12.3 and set it as the
default version:
