...
is the sum of its :ref:`total_staked<total_staked_quebec>` and
:ref:`total_delegated<total_delegated_quebec>` amounts, measured in
...
:src:`src/proto_021_PtQuebec/lib_protocol/amendment.ml`.
...
:src:`src/proto_021_PtQuebec/lib_protocol/operation_repr.ml`.
