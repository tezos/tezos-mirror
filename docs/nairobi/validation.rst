...
modes<validation_modes_nairobi>`. For example, these modes enable the
...
:ref:`operation_validity_nairobi` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_nairobi>`. That is,
...
block (see :ref:`partial_application_nairobi` above). This feature
...
:ref:`Manager operation<manager_operations_nairobi>` are a class of
...
A :ref:`batch<manager_operations_batches_nairobi>` of manager operations
